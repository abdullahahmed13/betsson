...
.field public g:Lcom/bumptech/glide/load/f;
...
.field public volatile o:Lcom/bumptech/glide/load/model/ModelLoader$LoadData;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.field public v:Lcom/bumptech/glide/load/engine/w;
...
.method private a()Z
    ...
    iget v0, p0, Lcom/bumptech/glide/load/engine/v;->j:I

    iget-object v1, p0, Lcom/bumptech/glide/load/engine/v;->i:Ljava/util/List;
...
.method public b()Z
    ...
    :cond_2
    :goto_0
    iget-object v3, p0, Lcom/bumptech/glide/load/engine/v;->i:Ljava/util/List;
    ...
    iput-object v0, p0, Lcom/bumptech/glide/load/engine/v;->o:Lcom/bumptech/glide/load/model/ModelLoader$LoadData;
    ...
    iget-object v0, p0, Lcom/bumptech/glide/load/engine/v;->i:Ljava/util/List;

    iget v1, p0, Lcom/bumptech/glide/load/engine/v;->j:I

    add-int/lit8 v3, v1, 0x1

    iput v3, p0, Lcom/bumptech/glide/load/engine/v;->j:I
    ...
    iget-object v1, p0, Lcom/bumptech/glide/load/engine/v;->p:Ljava/io/File;

    iget-object v3, p0, Lcom/bumptech/glide/load/engine/v;->d:Lcom/bumptech/glide/load/engine/g;
    ...
    iget-object v0, p0, Lcom/bumptech/glide/load/engine/v;->o:Lcom/bumptech/glide/load/model/ModelLoader$LoadData;

    if-eqz v0, :cond_4

    iget-object v0, p0, Lcom/bumptech/glide/load/engine/v;->d:Lcom/bumptech/glide/load/engine/g;

    iget-object v1, p0, Lcom/bumptech/glide/load/engine/v;->o:Lcom/bumptech/glide/load/model/ModelLoader$LoadData;
    ...
    invoke-interface {v0, v1, p0}, Lcom/bumptech/glide/load/data/d;->loadData(Lcom/bumptech/glide/g;Lcom/bumptech/glide/load/data/d$a;)V
    :try_end_2
    ...
    :goto_2
    :try_start_3
    iget v3, p0, Lcom/bumptech/glide/load/engine/v;->f:I
    ...
    :cond_7
    :try_start_4
    iput v2, p0, Lcom/bumptech/glide/load/engine/v;->f:I
    ...
    check-cast v6, Lcom/bumptech/glide/load/f;
    ...
    invoke-virtual {v3, v11}, Lcom/bumptech/glide/load/engine/g;->s(Ljava/lang/Class;)Lcom/bumptech/glide/load/l;
    ...
    invoke-virtual {v3}, Lcom/bumptech/glide/load/engine/g;->b()Lcom/bumptech/glide/load/engine/bitmap_recycle/b;
    ...
    invoke-virtual {v3}, Lcom/bumptech/glide/load/engine/g;->f()I

    move-result v9

    iget-object v3, p0, Lcom/bumptech/glide/load/engine/v;->d:Lcom/bumptech/glide/load/engine/g;

    invoke-virtual {v3}, Lcom/bumptech/glide/load/engine/g;->k()Lcom/bumptech/glide/load/h;
    ...
    iput-object v4, p0, Lcom/bumptech/glide/load/engine/v;->v:Lcom/bumptech/glide/load/engine/w;
    ...
    iget-object v4, p0, Lcom/bumptech/glide/load/engine/v;->v:Lcom/bumptech/glide/load/engine/w;

    invoke-interface {v3, v4}, Lcom/bumptech/glide/load/engine/cache/a;->b(Lcom/bumptech/glide/load/f;)Ljava/io/File;

    move-result-object v3

    iput-object v3, p0, Lcom/bumptech/glide/load/engine/v;->p:Ljava/io/File;

    if-eqz v3, :cond_2

    iput-object v6, p0, Lcom/bumptech/glide/load/engine/v;->g:Lcom/bumptech/glide/load/f;

    iget-object v4, p0, Lcom/bumptech/glide/load/engine/v;->d:Lcom/bumptech/glide/load/engine/g;

    invoke-virtual {v4, v3}, Lcom/bumptech/glide/load/engine/g;->j(Ljava/io/File;)Ljava/util/List;

    move-result-object v3

    iput-object v3, p0, Lcom/bumptech/glide/load/engine/v;->i:Ljava/util/List;

    iput v2, p0, Lcom/bumptech/glide/load/engine/v;->j:I
    :try_end_4
...
.method public onDataReady(Ljava/lang/Object;)V
    ...
    iget-object v1, p0, Lcom/bumptech/glide/load/engine/v;->g:Lcom/bumptech/glide/load/f;

    iget-object v2, p0, Lcom/bumptech/glide/load/engine/v;->o:Lcom/bumptech/glide/load/model/ModelLoader$LoadData;
    ...
    iget-object v5, p0, Lcom/bumptech/glide/load/engine/v;->v:Lcom/bumptech/glide/load/engine/w;
...
.method public onLoadFailed(Ljava/lang/Exception;)V
    ...
    iget-object v1, p0, Lcom/bumptech/glide/load/engine/v;->v:Lcom/bumptech/glide/load/engine/w;
