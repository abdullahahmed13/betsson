...
.field public final e:Lcom/bumptech/glide/load/engine/f$a;
...
.method public constructor <init>(Ljava/util/List;Lcom/bumptech/glide/load/engine/g;Lcom/bumptech/glide/load/engine/f$a;)V
    ...
    .line 4
    iput-object p1, p0, Lcom/bumptech/glide/load/engine/c;->c:Ljava/util/List;
...
.method private a()Z
    ...
    iget v0, p0, Lcom/bumptech/glide/load/engine/c;->j:I

    iget-object v1, p0, Lcom/bumptech/glide/load/engine/c;->i:Ljava/util/List;
...
.method public b()Z
    ...
    :goto_0
    :try_start_0
    iget-object v0, p0, Lcom/bumptech/glide/load/engine/c;->i:Ljava/util/List;
    ...
    iput-object v0, p0, Lcom/bumptech/glide/load/engine/c;->o:Lcom/bumptech/glide/load/model/ModelLoader$LoadData;
    ...
    iget v3, p0, Lcom/bumptech/glide/load/engine/c;->j:I

    add-int/lit8 v4, v3, 0x1

    iput v4, p0, Lcom/bumptech/glide/load/engine/c;->j:I
    ...
    iget-object v3, p0, Lcom/bumptech/glide/load/engine/c;->p:Ljava/io/File;
    ...
    iget-object v0, p0, Lcom/bumptech/glide/load/engine/c;->o:Lcom/bumptech/glide/load/model/ModelLoader$LoadData;

    if-eqz v0, :cond_2

    iget-object v0, p0, Lcom/bumptech/glide/load/engine/c;->d:Lcom/bumptech/glide/load/engine/g;

    iget-object v3, p0, Lcom/bumptech/glide/load/engine/c;->o:Lcom/bumptech/glide/load/model/ModelLoader$LoadData;
    ...
    invoke-interface {v0, v2, p0}, Lcom/bumptech/glide/load/data/d;->loadData(Lcom/bumptech/glide/g;Lcom/bumptech/glide/load/data/d$a;)V
    :try_end_0
    ...
    iget-object v1, p0, Lcom/bumptech/glide/load/engine/c;->c:Ljava/util/List;
    ...
    iput-object v1, p0, Lcom/bumptech/glide/load/engine/c;->p:Ljava/io/File;

    if-eqz v1, :cond_0

    iput-object v0, p0, Lcom/bumptech/glide/load/engine/c;->g:Lcom/bumptech/glide/load/f;
    ...
    iput-object v0, p0, Lcom/bumptech/glide/load/engine/c;->i:Ljava/util/List;

    iput v2, p0, Lcom/bumptech/glide/load/engine/c;->j:I
    :try_end_2
...
.method public onDataReady(Ljava/lang/Object;)V
    ...
    iget-object v1, p0, Lcom/bumptech/glide/load/engine/c;->g:Lcom/bumptech/glide/load/f;

    iget-object v2, p0, Lcom/bumptech/glide/load/engine/c;->o:Lcom/bumptech/glide/load/model/ModelLoader$LoadData;
    ...
    iget-object v5, p0, Lcom/bumptech/glide/load/engine/c;->g:Lcom/bumptech/glide/load/f;
