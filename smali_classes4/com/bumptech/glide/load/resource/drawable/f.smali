.class public final Lcom/bumptech/glide/load/resource/drawable/f;
...
.method public static a(Landroid/content/Context;ILandroid/content/res/Resources$Theme;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {p0, p0, p1, p2}, Lcom/bumptech/glide/load/resource/drawable/f;->c(Landroid/content/Context;Landroid/content/Context;ILandroid/content/res/Resources$Theme;)Landroid/graphics/drawable/Drawable;
...
.method public static b(Landroid/content/Context;Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {p0, p1, p2, v0}, Lcom/bumptech/glide/load/resource/drawable/f;->c(Landroid/content/Context;Landroid/content/Context;ILandroid/content/res/Resources$Theme;)Landroid/graphics/drawable/Drawable;
...
.method public static c(Landroid/content/Context;Landroid/content/Context;ILandroid/content/res/Resources$Theme;)Landroid/graphics/drawable/Drawable;
    ...
    :try_start_0
    sget-boolean v0, Lcom/bumptech/glide/load/resource/drawable/f;->a:Z

    if-eqz v0, :cond_1

    invoke-static {p1, p2, p3}, Lcom/bumptech/glide/load/resource/drawable/f;->e(Landroid/content/Context;ILandroid/content/res/Resources$Theme;)Landroid/graphics/drawable/Drawable;
    ...
    sput-boolean p0, Lcom/bumptech/glide/load/resource/drawable/f;->a:Z
    ...
    :goto_0
    invoke-static {p1, p2, p3}, Lcom/bumptech/glide/load/resource/drawable/f;->d(Landroid/content/Context;ILandroid/content/res/Resources$Theme;)Landroid/graphics/drawable/Drawable;
