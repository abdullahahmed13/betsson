.class public abstract Lobg/android/oneapp/d;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lobg/android/oneapp/d;->e:Ljava/lang/Object;

    const/4 v0, 0x0

    iput-boolean v0, p0, Lobg/android/oneapp/d;->f:Z

    invoke-direct {p0}, Lobg/android/oneapp/d;->M0()V
...
.method private M0()V
    ...
    new-instance v0, Lobg/android/oneapp/d$a;

    invoke-direct {v0, p0}, Lobg/android/oneapp/d$a;-><init>(Lobg/android/oneapp/d;)V
...
.method private P0()V
    ...
    invoke-virtual {p0}, Lobg/android/oneapp/d;->N0()Ldagger/hilt/android/internal/managers/a;
    ...
    iput-object v0, p0, Lobg/android/oneapp/d;->c:Ldagger/hilt/android/internal/managers/h;
    ...
    iget-object v0, p0, Lobg/android/oneapp/d;->c:Ldagger/hilt/android/internal/managers/h;
...
.method public final N0()Ldagger/hilt/android/internal/managers/a;
    ...
    iget-object v0, p0, Lobg/android/oneapp/d;->d:Ldagger/hilt/android/internal/managers/a;

    if-nez v0, :cond_1

    iget-object v0, p0, Lobg/android/oneapp/d;->e:Ljava/lang/Object;

    monitor-enter v0

    :try_start_0
    iget-object v1, p0, Lobg/android/oneapp/d;->d:Ldagger/hilt/android/internal/managers/a;

    if-nez v1, :cond_0

    invoke-virtual {p0}, Lobg/android/oneapp/d;->O0()Ldagger/hilt/android/internal/managers/a;

    move-result-object v1

    iput-object v1, p0, Lobg/android/oneapp/d;->d:Ldagger/hilt/android/internal/managers/a;
...
.method public Q0()V
    ...
    iget-boolean v0, p0, Lobg/android/oneapp/d;->f:Z
    ...
    invoke-virtual {p0}, Lobg/android/oneapp/d;->f0()Ljava/lang/Object;

    move-result-object v0

    check-cast v0, Lobg/android/oneapp/u;

    invoke-static {p0}, Ldagger/hilt/internal/e;->a(Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v1

    check-cast v1, Lobg/android/oneapp/OneAppMainActivity;

    invoke-interface {v0, v1}, Lobg/android/oneapp/u;->e(Lobg/android/oneapp/OneAppMainActivity;)V
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    invoke-direct {p0}, Lobg/android/oneapp/d;->P0()V
