.class public abstract Lobg/android/pam/spid/ui/c;
...
.method public constructor <init>(I)V
    ...
    iput-object p1, p0, Lobg/android/pam/spid/ui/c;->g:Ljava/lang/Object;

    const/4 p1, 0x0

    iput-boolean p1, p0, Lobg/android/pam/spid/ui/c;->i:Z
...
.method private l1()V
    ...
    iget-object v0, p0, Lobg/android/pam/spid/ui/c;->d:Landroid/content/ContextWrapper;
    ...
    iput-object v0, p0, Lobg/android/pam/spid/ui/c;->d:Landroid/content/ContextWrapper;
    ...
    iput-boolean v0, p0, Lobg/android/pam/spid/ui/c;->e:Z
...
.method public final f0()Ljava/lang/Object;
    ...
    invoke-virtual {p0}, Lobg/android/pam/spid/ui/c;->j1()Ldagger/hilt/android/internal/managers/g;
...
.method public getContext()Landroid/content/Context;
    ...
    iget-boolean v0, p0, Lobg/android/pam/spid/ui/c;->e:Z
    ...
    :cond_0
    invoke-direct {p0}, Lobg/android/pam/spid/ui/c;->l1()V
...
.method public final j1()Ldagger/hilt/android/internal/managers/g;
    ...
    iget-object v0, p0, Lobg/android/pam/spid/ui/c;->f:Ldagger/hilt/android/internal/managers/g;

    if-nez v0, :cond_1

    iget-object v0, p0, Lobg/android/pam/spid/ui/c;->g:Ljava/lang/Object;

    monitor-enter v0

    :try_start_0
    iget-object v1, p0, Lobg/android/pam/spid/ui/c;->f:Ldagger/hilt/android/internal/managers/g;

    if-nez v1, :cond_0

    invoke-virtual {p0}, Lobg/android/pam/spid/ui/c;->k1()Ldagger/hilt/android/internal/managers/g;

    move-result-object v1

    iput-object v1, p0, Lobg/android/pam/spid/ui/c;->f:Ldagger/hilt/android/internal/managers/g;
...
.method public m1()V
    ...
    iget-boolean v0, p0, Lobg/android/pam/spid/ui/c;->i:Z

    if-nez v0, :cond_0

    const/4 v0, 0x1

    iput-boolean v0, p0, Lobg/android/pam/spid/ui/c;->i:Z

    invoke-virtual {p0}, Lobg/android/pam/spid/ui/c;->f0()Ljava/lang/Object;

    move-result-object v0

    check-cast v0, Lobg/android/pam/spid/ui/n0;

    invoke-static {p0}, Ldagger/hilt/internal/e;->a(Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v1

    check-cast v1, Lobg/android/pam/spid/ui/SpidRegistrationOptionsFragment;

    invoke-interface {v0, v1}, Lobg/android/pam/spid/ui/n0;->G0(Lobg/android/pam/spid/ui/SpidRegistrationOptionsFragment;)V
...
.method public onAttach(Landroid/app/Activity;)V
    ...
    .line 7
    invoke-virtual {p0}, Lobg/android/pam/spid/ui/c;->m1()V
