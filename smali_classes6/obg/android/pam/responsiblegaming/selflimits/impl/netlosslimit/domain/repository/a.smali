.class public final Lobg/android/pam/responsiblegaming/selflimits/impl/netlosslimit/domain/repository/a;
.super Ljava/lang/Object;
.source "SourceFile"

# interfaces
.implements Lobg/android/pam/responsiblegaming/selflimits/netlosslimit/domain/repository/a;
...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        "Lobg/android/pam/responsiblegaming/selflimits/impl/netlosslimit/domain/repository/a;",
        ...
        "netLossLimitDataSource",
        "<init>",
        "(Lobg/android/pam/responsiblegaming/selflimits/netlosslimit/domain/data/a;)V",
...
.annotation build Lkotlin/jvm/internal/SourceDebugExtension;
    value = {
        "SMAP\nNetLossLimitRepositoryImpl.kt\nKotlin\n*S Kotlin\n*F\n+ 1 NetLossLimitRepositoryImpl.kt\nobg/android/pam/responsiblegaming/selflimits/impl/netlosslimit/domain/repository/NetLossLimitRepositoryImpl\n+ 2 CallCatching.kt\nobg/android/common/extensions/CallCatchingKt\n+ 3 CallCatching.kt\nobg/android/common/extensions/CallCatchingKt$callCatching$2\n+ 4 Result.kt\nobg/android/shared/domain/model/Result\n+ 5 Result.kt\nobg/android/shared/domain/model/ResultKt\n+ 6 _Collections.kt\nkotlin/collections/CollectionsKt___CollectionsKt\n*L\n1#1,64:1\n28#2,30:65\n59#2:100\n28#2,30:109\n59#2:144\n40#3,5:95\n40#3,5:139\n78#4:101\n78#4:145\n125#5,2:102\n127#5:108\n125#5,3:146\n1563#6:104\n1634#6,3:105\n*S KotlinDebug\n*F\n+ 1 NetLossLimitRepositoryImpl.kt\nobg/android/pam/responsiblegaming/selflimits/impl/netlosslimit/domain/repository/NetLossLimitRepositoryImpl\n*L\n25#1:65,30\n25#1:100\n48#1:109,30\n48#1:144\n25#1:95,5\n48#1:139,5\n42#1:101\n60#1:145\n42#1:102,2\n42#1:108\n60#1:146,3\n43#1:104\n43#1:105,3\n*E\n"
    }
.end annotation


# instance fields
.field public final a:Lobg/android/pam/responsiblegaming/selflimits/netlosslimit/domain/data/a;
...
# direct methods
.method public constructor <init>(Lobg/android/pam/responsiblegaming/selflimits/netlosslimit/domain/data/a;)V
    .locals 1
    .param p1    # Lobg/android/pam/responsiblegaming/selflimits/netlosslimit/domain/data/a;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    .end param

    const-string v0, "netLossLimitDataSource"

    invoke-static {p1, v0}, Lkotlin/jvm/internal/Intrinsics;->checkNotNullParameter(Ljava/lang/Object;Ljava/lang/String;)V

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lobg/android/pam/responsiblegaming/selflimits/impl/netlosslimit/domain/repository/a;->a:Lobg/android/pam/responsiblegaming/selflimits/netlosslimit/domain/data/a;
...
# virtual methods
.method public a(Lobg/android/pam/responsiblegaming/selflimits/netlosslimit/domain/dto/NetLossLimitRequestModel;Lkotlin/coroutines/e;)Ljava/lang/Object;
    .locals 12
    ...
    instance-of v0, p2, Lobg/android/pam/responsiblegaming/selflimits/impl/netlosslimit/domain/repository/a$b;

    if-eqz v0, :cond_0

    move-object v0, p2

    check-cast v0, Lobg/android/pam/responsiblegaming/selflimits/impl/netlosslimit/domain/repository/a$b;

    iget v1, v0, Lobg/android/pam/responsiblegaming/selflimits/impl/netlosslimit/domain/repository/a$b;->e:I
    ...
    iput v1, v0, Lobg/android/pam/responsiblegaming/selflimits/impl/netlosslimit/domain/repository/a$b;->e:I

    goto :goto_0

    :cond_0
    new-instance v0, Lobg/android/pam/responsiblegaming/selflimits/impl/netlosslimit/domain/repository/a$b;

    invoke-direct {v0, p0, p2}, Lobg/android/pam/responsiblegaming/selflimits/impl/netlosslimit/domain/repository/a$b;-><init>(Lobg/android/pam/responsiblegaming/selflimits/impl/netlosslimit/domain/repository/a;Lkotlin/coroutines/e;)V

    :goto_0
    iget-object p2, v0, Lobg/android/pam/responsiblegaming/selflimits/impl/netlosslimit/domain/repository/a$b;->c:Ljava/lang/Object;

    invoke-static {}, Lkotlin/coroutines/intrinsics/c;->g()Ljava/lang/Object;

    move-result-object v1

    iget v2, v0, Lobg/android/pam/responsiblegaming/selflimits/impl/netlosslimit/domain/repository/a$b;->e:I
    ...
    :try_start_1
    iget-object p2, p0, Lobg/android/pam/responsiblegaming/selflimits/impl/netlosslimit/domain/repository/a;->a:Lobg/android/pam/responsiblegaming/selflimits/netlosslimit/domain/data/a;

    invoke-static {p1}, Lobg/android/pam/responsiblegaming/selflimits/impl/netlosslimit/mapper/a;->b(Lobg/android/pam/responsiblegaming/selflimits/netlosslimit/domain/dto/NetLossLimitRequestModel;)Lobg/android/pam/responsiblegaming/selflimits/netlosslimit/domain/dto/NetLossLimitRequest;

    move-result-object p1

    iput v3, v0, Lobg/android/pam/responsiblegaming/selflimits/impl/netlosslimit/domain/repository/a$b;->e:I

    invoke-interface {p2, p1, v0}, Lobg/android/pam/responsiblegaming/selflimits/netlosslimit/domain/data/a;->a(Lobg/android/pam/responsiblegaming/selflimits/netlosslimit/domain/dto/NetLossLimitRequest;Lkotlin/coroutines/e;)Ljava/lang/Object;
    ...
    invoke-static {p1}, Lobg/android/pam/responsiblegaming/selflimits/impl/netlosslimit/mapper/a;->a(Lobg/android/pam/responsiblegaming/selflimits/netlosslimit/domain/dto/NetLossLimitResponse;)Lobg/android/pam/responsiblegaming/selflimits/netlosslimit/domain/dto/NetLossLimitResponseModel;
...
.method public b(Lkotlin/coroutines/e;)Ljava/lang/Object;
    ...
    instance-of v0, p1, Lobg/android/pam/responsiblegaming/selflimits/impl/netlosslimit/domain/repository/a$a;

    if-eqz v0, :cond_0

    move-object v0, p1

    check-cast v0, Lobg/android/pam/responsiblegaming/selflimits/impl/netlosslimit/domain/repository/a$a;

    iget v1, v0, Lobg/android/pam/responsiblegaming/selflimits/impl/netlosslimit/domain/repository/a$a;->e:I
    ...
    iput v1, v0, Lobg/android/pam/responsiblegaming/selflimits/impl/netlosslimit/domain/repository/a$a;->e:I

    goto :goto_0

    :cond_0
    new-instance v0, Lobg/android/pam/responsiblegaming/selflimits/impl/netlosslimit/domain/repository/a$a;

    invoke-direct {v0, p0, p1}, Lobg/android/pam/responsiblegaming/selflimits/impl/netlosslimit/domain/repository/a$a;-><init>(Lobg/android/pam/responsiblegaming/selflimits/impl/netlosslimit/domain/repository/a;Lkotlin/coroutines/e;)V

    :goto_0
    iget-object p1, v0, Lobg/android/pam/responsiblegaming/selflimits/impl/netlosslimit/domain/repository/a$a;->c:Ljava/lang/Object;

    invoke-static {}, Lkotlin/coroutines/intrinsics/c;->g()Ljava/lang/Object;

    move-result-object v1

    iget v2, v0, Lobg/android/pam/responsiblegaming/selflimits/impl/netlosslimit/domain/repository/a$a;->e:I
    ...
    :try_start_1
    iget-object p1, p0, Lobg/android/pam/responsiblegaming/selflimits/impl/netlosslimit/domain/repository/a;->a:Lobg/android/pam/responsiblegaming/selflimits/netlosslimit/domain/data/a;

    iput v3, v0, Lobg/android/pam/responsiblegaming/selflimits/impl/netlosslimit/domain/repository/a$a;->e:I

    invoke-interface {p1, v0}, Lobg/android/pam/responsiblegaming/selflimits/netlosslimit/domain/data/a;->b(Lkotlin/coroutines/e;)Ljava/lang/Object;
    ...
    check-cast v1, Lobg/android/pam/responsiblegaming/selflimits/netlosslimit/domain/dto/NetLossLimitResponse;

    invoke-static {v1}, Lobg/android/pam/responsiblegaming/selflimits/impl/netlosslimit/mapper/a;->a(Lobg/android/pam/responsiblegaming/selflimits/netlosslimit/domain/dto/NetLossLimitResponse;)Lobg/android/pam/responsiblegaming/selflimits/netlosslimit/domain/dto/NetLossLimitResponseModel;
