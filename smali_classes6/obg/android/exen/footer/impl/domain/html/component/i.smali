.class public final Lobg/android/exen/footer/impl/domain/html/component/i;
...
.annotation build Lkotlin/jvm/internal/SourceDebugExtension;
    value = {
        "SMAP\nTextFooterHtmlGenerator.kt\nKotlin\n*S Kotlin\n*F\n+ 1 TextFooterHtmlGenerator.kt\nobg/android/exen/footer/impl/domain/html/component/TextFooterHtmlGenerator\n+ 2 fake.kt\nkotlin/jvm/internal/FakeKt\n*L\n1#1,29:1\n1#2:30\n*E\n"
    }
.end annotation
...
.method public constructor <init>(Lobg/android/exen/footer/impl/domain/html/b;Lobg/android/exen/footer/impl/domain/d;Lobg/android/exen/footer/impl/domain/g;)V
    ...
    iput-object p1, p0, Lobg/android/exen/footer/impl/domain/html/component/i;->a:Lobg/android/exen/footer/impl/domain/html/b;

    iput-object p2, p0, Lobg/android/exen/footer/impl/domain/html/component/i;->b:Lobg/android/exen/footer/impl/domain/d;

    iput-object p3, p0, Lobg/android/exen/footer/impl/domain/html/component/i;->c:Lobg/android/exen/footer/impl/domain/g;

    return-void
.end method

.method public static synthetic c(Lobg/android/exen/footer/impl/domain/html/component/i;Lobg/android/exen/footer/domain/model/FooterItem;)Ljava/lang/String;
    .locals 0

    invoke-static {p0, p1}, Lobg/android/exen/footer/impl/domain/html/component/i;->d(Lobg/android/exen/footer/impl/domain/html/component/i;Lobg/android/exen/footer/domain/model/FooterItem;)Ljava/lang/String;
...
.method public static final d(Lobg/android/exen/footer/impl/domain/html/component/i;Lobg/android/exen/footer/domain/model/FooterItem;)Ljava/lang/String;
    .locals 3
    ...
    iget-object v0, p0, Lobg/android/exen/footer/impl/domain/html/component/i;->c:Lobg/android/exen/footer/impl/domain/g;
    ...
    const-string v2, "padding-left: 24px; padding-right: 24px; word-wrap: break-word; overflow-wrap: break-word;"
    ...
    iget-object p0, p0, Lobg/android/exen/footer/impl/domain/html/component/i;->b:Lobg/android/exen/footer/impl/domain/d;
    ...
    const-string v2, "<a target=\'_blank\' href=\'"

    invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v1, v0}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    const-string v0, "\'><div style=\'"
...
.method public a(Lobg/android/exen/footer/domain/model/FooterType;)Z
    ...
    sget-object v0, Lobg/android/exen/footer/domain/model/FooterType;->TEXT:Lobg/android/exen/footer/domain/model/FooterType;
...
.method public b(Lobg/android/exen/footer/domain/model/Footer;)Ljava/lang/String;
    ...
    iget-object v1, p0, Lobg/android/exen/footer/impl/domain/html/component/i;->a:Lobg/android/exen/footer/impl/domain/html/b;

    new-instance v4, Lobg/android/exen/footer/impl/domain/html/component/h;

    invoke-direct {v4, p0}, Lobg/android/exen/footer/impl/domain/html/component/h;-><init>(Lobg/android/exen/footer/impl/domain/html/component/i;)V
