.class public final Lobg/android/exen/widget/presentation/SmallAppWidget;
.super Lobg/android/exen/widget/presentation/n;
.source "SourceFile"
...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        "Lobg/android/exen/widget/presentation/SmallAppWidget;",
...
.method public constructor <init>()V
    ...
    invoke-direct {p0}, Lobg/android/exen/widget/presentation/n;-><init>()V
...
.method public final b()Lobg/android/common/preferences/a;
    ...
    iget-object v0, p0, Lobg/android/exen/widget/presentation/SmallAppWidget;->d:Lobg/android/common/preferences/a;
...
.method public final c()Lobg/android/platform/translations/models/Translations;
    ...
    iget-object v0, p0, Lobg/android/exen/widget/presentation/SmallAppWidget;->c:Lobg/android/platform/translations/models/Translations;
...
.method public onReceive(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    invoke-super {p0, p1, p2}, Lobg/android/exen/widget/presentation/n;->onReceive(Landroid/content/Context;Landroid/content/Intent;)V

    invoke-virtual {p0}, Lobg/android/exen/widget/presentation/SmallAppWidget;->b()Lobg/android/common/preferences/a;
...
.method public onUpdate(Landroid/content/Context;Landroid/appwidget/AppWidgetManager;[I)V
    ...
    invoke-virtual {p0}, Lobg/android/exen/widget/presentation/SmallAppWidget;->c()Lobg/android/platform/translations/models/Translations;

    move-result-object v4

    const-class v5, Lobg/android/exen/widget/presentation/SmallAppWidget;
    ...
    invoke-static {v4, p1, v3, v0, v5}, Lobg/android/exen/widget/presentation/v;->d(Lobg/android/platform/translations/models/Translations;Landroid/content/Context;IZLandroid/app/PendingIntent;)Landroid/widget/RemoteViews;
