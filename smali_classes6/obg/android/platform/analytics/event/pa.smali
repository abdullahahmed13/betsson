.class public final Lobg/android/platform/analytics/event/pa;
...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        "Lobg/android/platform/analytics/event/pa;",
...
# static fields
.field public static final f:Lobg/android/platform/analytics/event/pa;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lobg/android/platform/analytics/event/pa;

    invoke-direct {v0}, Lobg/android/platform/analytics/event/pa;-><init>()V

    sput-object v0, Lobg/android/platform/analytics/event/pa;->f:Lobg/android/platform/analytics/event/pa;
...
.method public constructor <init>()V
    ...
    new-instance v0, Lobg/android/platform/analytics/event/oa;

    invoke-direct {v0}, Lobg/android/platform/analytics/event/oa;-><init>()V

    const/4 v1, 0x0

    const-string v2, "registration_next"
...
.method public static synthetic a(Lobg/android/platform/analytics/domain/model/event/EventConfigurator;)Lkotlin/Unit;
    ...
    invoke-static {p0}, Lobg/android/platform/analytics/event/pa;->b(Lobg/android/platform/analytics/domain/model/event/EventConfigurator;)Lkotlin/Unit;
...
.method public equals(Ljava/lang/Object;)Z
    ...
    :cond_0
    instance-of p1, p1, Lobg/android/platform/analytics/event/pa;
...
.method public toString()Ljava/lang/String;
    ...
    const-string v0, "RegistrationNextAction"
