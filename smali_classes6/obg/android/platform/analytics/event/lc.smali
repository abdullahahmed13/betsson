.class public final Lobg/android/platform/analytics/event/lc;
...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        "Lobg/android/platform/analytics/event/lc;",
...
# static fields
.field public static final f:Lobg/android/platform/analytics/event/lc;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lobg/android/platform/analytics/event/lc;

    invoke-direct {v0}, Lobg/android/platform/analytics/event/lc;-><init>()V

    sput-object v0, Lobg/android/platform/analytics/event/lc;->f:Lobg/android/platform/analytics/event/lc;
...
.method public constructor <init>()V
    ...
    new-instance v0, Lobg/android/platform/analytics/event/kc;

    invoke-direct {v0}, Lobg/android/platform/analytics/event/kc;-><init>()V

    const/4 v1, 0x0

    const-string v2, "splash_browse"
...
.method public static synthetic a(Lobg/android/platform/analytics/domain/model/event/EventConfigurator;)Lkotlin/Unit;
    ...
    invoke-static {p0}, Lobg/android/platform/analytics/event/lc;->b(Lobg/android/platform/analytics/domain/model/event/EventConfigurator;)Lkotlin/Unit;
...
.method public equals(Ljava/lang/Object;)Z
    ...
    :cond_0
    instance-of p1, p1, Lobg/android/platform/analytics/event/lc;
...
.method public toString()Ljava/lang/String;
    ...
    const-string v0, "SplashChooseBetweenAction"
