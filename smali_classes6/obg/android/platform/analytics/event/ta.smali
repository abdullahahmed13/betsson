.class public final Lobg/android/platform/analytics/event/ta;
...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        "Lobg/android/platform/analytics/event/ta;",
...
# static fields
.field public static final f:Lobg/android/platform/analytics/event/ta;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lobg/android/platform/analytics/event/ta;

    invoke-direct {v0}, Lobg/android/platform/analytics/event/ta;-><init>()V

    sput-object v0, Lobg/android/platform/analytics/event/ta;->f:Lobg/android/platform/analytics/event/ta;
...
.method public constructor <init>()V
    ...
    new-instance v0, Lobg/android/platform/analytics/event/sa;

    invoke-direct {v0}, Lobg/android/platform/analytics/event/sa;-><init>()V

    const/4 v1, 0x0

    const-string v2, "registration_submit"
...
.method public static synthetic a(Lobg/android/platform/analytics/domain/model/event/EventConfigurator;)Lkotlin/Unit;
    ...
    invoke-static {p0}, Lobg/android/platform/analytics/event/ta;->b(Lobg/android/platform/analytics/domain/model/event/EventConfigurator;)Lkotlin/Unit;
...
.method public equals(Ljava/lang/Object;)Z
    ...
    :cond_0
    instance-of p1, p1, Lobg/android/platform/analytics/event/ta;
...
.method public toString()Ljava/lang/String;
    ...
    const-string v0, "RegistrationSubmitAction"
