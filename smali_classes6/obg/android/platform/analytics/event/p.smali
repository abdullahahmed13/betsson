.class public final Lobg/android/platform/analytics/event/p;
...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        "Lobg/android/platform/analytics/event/p;",
...
# static fields
.field public static final f:Lobg/android/platform/analytics/event/p;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lobg/android/platform/analytics/event/p;

    invoke-direct {v0}, Lobg/android/platform/analytics/event/p;-><init>()V

    sput-object v0, Lobg/android/platform/analytics/event/p;->f:Lobg/android/platform/analytics/event/p;
...
.method public constructor <init>()V
    ...
    new-instance v0, Lobg/android/platform/analytics/event/o;

    invoke-direct {v0}, Lobg/android/platform/analytics/event/o;-><init>()V

    const/4 v1, 0x0

    const-string v2, "error_bankid_missing_close"
...
.method public static synthetic a(Lobg/android/platform/analytics/domain/model/event/EventConfigurator;)Lkotlin/Unit;
    ...
    invoke-static {p0}, Lobg/android/platform/analytics/event/p;->b(Lobg/android/platform/analytics/domain/model/event/EventConfigurator;)Lkotlin/Unit;
...
.method public equals(Ljava/lang/Object;)Z
    ...
    :cond_0
    instance-of p1, p1, Lobg/android/platform/analytics/event/p;
...
.method public toString()Ljava/lang/String;
    ...
    const-string v0, "BankIdMissingCloseAction"
