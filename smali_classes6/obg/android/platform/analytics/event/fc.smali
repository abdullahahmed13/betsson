.class public final Lobg/android/platform/analytics/event/fc;
...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        "Lobg/android/platform/analytics/event/fc;",
...
# static fields
.field public static final f:Lobg/android/platform/analytics/event/fc;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lobg/android/platform/analytics/event/fc;

    invoke-direct {v0}, Lobg/android/platform/analytics/event/fc;-><init>()V

    sput-object v0, Lobg/android/platform/analytics/event/fc;->f:Lobg/android/platform/analytics/event/fc;
...
.method public constructor <init>()V
    ...
    new-instance v0, Lobg/android/platform/analytics/event/ec;

    invoke-direct {v0}, Lobg/android/platform/analytics/event/ec;-><init>()V

    const/4 v1, 0x0

    const-string v2, "tournament_show_all_clicked"
...
.method public static synthetic a(Lobg/android/platform/analytics/domain/model/event/EventConfigurator;)Lkotlin/Unit;
    ...
    invoke-static {p0}, Lobg/android/platform/analytics/event/fc;->b(Lobg/android/platform/analytics/domain/model/event/EventConfigurator;)Lkotlin/Unit;
...
.method public equals(Ljava/lang/Object;)Z
    ...
    :cond_0
    instance-of p1, p1, Lobg/android/platform/analytics/event/fc;
...
.method public toString()Ljava/lang/String;
    ...
    const-string v0, "ShowAllTournamentsClickedAction"
