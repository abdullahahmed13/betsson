.class public final Lobg/android/platform/analytics/event/v1;
...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        "Lobg/android/platform/analytics/event/v1;",
...
# static fields
.field public static final f:Lobg/android/platform/analytics/event/v1;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lobg/android/platform/analytics/event/v1;

    invoke-direct {v0}, Lobg/android/platform/analytics/event/v1;-><init>()V

    sput-object v0, Lobg/android/platform/analytics/event/v1;->f:Lobg/android/platform/analytics/event/v1;
...
.method public constructor <init>()V
    ...
    new-instance v0, Lobg/android/platform/analytics/event/u1;

    invoke-direct {v0}, Lobg/android/platform/analytics/event/u1;-><init>()V

    const/4 v1, 0x0

    const-string v2, "privacy_consent_changed"
...
.method public static synthetic a(Lobg/android/platform/analytics/domain/model/event/EventConfigurator;)Lkotlin/Unit;
    ...
    invoke-static {p0}, Lobg/android/platform/analytics/event/v1;->b(Lobg/android/platform/analytics/domain/model/event/EventConfigurator;)Lkotlin/Unit;
...
.method public equals(Ljava/lang/Object;)Z
    ...
    :cond_0
    instance-of p1, p1, Lobg/android/platform/analytics/event/v1;
...
.method public toString()Ljava/lang/String;
    ...
    const-string v0, "ConsentPrivacyChanged"
