...
# static fields
.field public static final b:Lkotlinx/datetime/format/s$a;
...
.field public static final d:Lkotlinx/datetime/format/s;
    .annotation build Lorg/jetbrains/annotations/NotNull;
    .end annotation
.end field
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lkotlinx/datetime/format/s$a;-><init>(Lkotlin/jvm/internal/DefaultConstructorMarker;)V

    sput-object v0, Lkotlinx/datetime/format/s;->b:Lkotlinx/datetime/format/s$a;
    ...
    invoke-direct {v0, v1}, Lkotlinx/datetime/format/s;-><init>(Ljava/util/List;)V

    sput-object v0, Lkotlinx/datetime/format/s;->c:Lkotlinx/datetime/format/s;
    ...
    sput-object v0, Lkotlinx/datetime/format/s;->d:Lkotlinx/datetime/format/s;
...
.method public constructor <init>(Ljava/util/List;)V
    ...
    iput-object p1, p0, Lkotlinx/datetime/format/s;->a:Ljava/util/List;
    ...
    iget-object v1, p0, Lkotlinx/datetime/format/s;->a:Ljava/util/List;
    ...
    iget-object v2, p0, Lkotlinx/datetime/format/s;->a:Ljava/util/List;

    invoke-interface {v2, v0}, Ljava/util/List;->get(I)Ljava/lang/Object;

    move-result-object v2

    iget-object v3, p0, Lkotlinx/datetime/format/s;->a:Ljava/util/List;
...
.method public static final synthetic a()Lkotlinx/datetime/format/s;
    .locals 1

    sget-object v0, Lkotlinx/datetime/format/s;->d:Lkotlinx/datetime/format/s;
...
.method public final b()Ljava/util/List;
    ...
    iget-object v0, p0, Lkotlinx/datetime/format/s;->a:Ljava/util/List;
...
.method public equals(Ljava/lang/Object;)Z
    ...
    iget-object p1, p1, Lkotlinx/datetime/format/s;->a:Ljava/util/List;
...
.method public toString()Ljava/lang/String;
    ...
    sget-object v6, Lkotlinx/datetime/format/s$b;->c:Lkotlinx/datetime/format/s$b;
