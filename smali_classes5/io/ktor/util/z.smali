...
.field public static final b:Lkotlinx/coroutines/channels/j;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lkotlinx/coroutines/channels/j<",
            "Ljava/lang/String;",
...
.field public static final d:Lkotlinx/coroutines/c2;
    .annotation build Lorg/jetbrains/annotations/NotNull;
    .end annotation
.end field
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lio/ktor/util/z;->a:Ljava/util/List;
    ...
    sput-object v0, Lio/ktor/util/z;->b:Lkotlinx/coroutines/channels/j;
    ...
    sput-object v0, Lio/ktor/util/z;->c:Lkotlinx/coroutines/o0;
    ...
    sget-object v3, Lkotlinx/coroutines/r0;->d:Lkotlinx/coroutines/r0;

    new-instance v4, Lio/ktor/util/z$a;

    invoke-direct {v4, v2}, Lio/ktor/util/z$a;-><init>(Lkotlin/coroutines/e;)V

    invoke-static {v1, v0, v3, v4}, Lkotlinx/coroutines/i;->c(Lkotlinx/coroutines/p0;Lkotlin/coroutines/CoroutineContext;Lkotlinx/coroutines/r0;Lkotlin/jvm/functions/Function2;)Lkotlinx/coroutines/c2;

    move-result-object v0

    sput-object v0, Lio/ktor/util/z;->d:Lkotlinx/coroutines/c2;
...
.method public static final synthetic a()Ljava/security/SecureRandom;
    ...
    invoke-static {}, Lio/ktor/util/z;->f()Ljava/security/SecureRandom;
...
.method public static final b()V
    ...
    sget-object v0, Lio/ktor/util/z;->d:Lkotlinx/coroutines/c2;
...
.method public static synthetic d(Ljava/lang/String;ILjava/lang/Object;)Ljava/security/SecureRandom;
    ...
    :cond_0
    invoke-static {p0}, Lio/ktor/util/z;->c(Ljava/lang/String;)Ljava/security/SecureRandom;
...
.method public static final e()Lkotlinx/coroutines/channels/j;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    sget-object v0, Lio/ktor/util/z;->b:Lkotlinx/coroutines/channels/j;
...
.method public static final f()Ljava/security/SecureRandom;
    ...
    invoke-static {v0}, Lio/ktor/util/z;->c(Ljava/lang/String;)Ljava/security/SecureRandom;
    ...
    :cond_0
    sget-object v0, Lio/ktor/util/z;->a:Ljava/util/List;
    ...
    invoke-static {v1}, Lio/ktor/util/z;->c(Ljava/lang/String;)Ljava/security/SecureRandom;
    ...
    sget-object v3, Lio/ktor/util/z;->a:Ljava/util/List;
    ...
    invoke-static {v1, v0, v1}, Lio/ktor/util/z;->d(Ljava/lang/String;ILjava/lang/Object;)Ljava/security/SecureRandom;
