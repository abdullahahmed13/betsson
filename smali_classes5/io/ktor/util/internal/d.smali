...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lio/ktor/util/internal/d;->e:Ljava/util/concurrent/atomic/AtomicReferenceFieldUpdater;
...
# virtual methods
.method public final a(Lio/ktor/util/internal/d;Lio/ktor/util/internal/e;)Lio/ktor/util/internal/d;
    .locals 6
    ...
    invoke-virtual {p1}, Lio/ktor/util/internal/d;->h()Lio/ktor/util/internal/d;

    sget-object v3, Lio/ktor/util/internal/d;->c:Ljava/util/concurrent/atomic/AtomicReferenceFieldUpdater;
    ...
    :cond_7
    sget-object v2, Lio/ktor/util/internal/d;->d:Ljava/util/concurrent/atomic/AtomicReferenceFieldUpdater;
...
.method public final b()Lio/ktor/util/internal/d;
    .locals 2
...
.method public final d(Lio/ktor/util/internal/d;)V
    .locals 2
    ...
    invoke-virtual {p1, v0, v1}, Lio/ktor/util/internal/d;->a(Lio/ktor/util/internal/d;Lio/ktor/util/internal/e;)Lio/ktor/util/internal/d;
...
.method public final g()V
    ...
    invoke-virtual {p0}, Lio/ktor/util/internal/d;->h()Lio/ktor/util/internal/d;
    ...
    invoke-virtual {v1}, Lio/ktor/util/internal/d;->h()Lio/ktor/util/internal/d;
    ...
    invoke-virtual {v0}, Lio/ktor/util/internal/d;->h()Lio/ktor/util/internal/d;

    sget-object v5, Lio/ktor/util/internal/d;->c:Ljava/util/concurrent/atomic/AtomicReferenceFieldUpdater;
    ...
    :cond_5
    sget-object v4, Lio/ktor/util/internal/d;->c:Ljava/util/concurrent/atomic/AtomicReferenceFieldUpdater;
...
.method public final h()Lio/ktor/util/internal/d;
    .locals 3
    ...
    invoke-virtual {p0}, Lio/ktor/util/internal/d;->b()Lio/ktor/util/internal/d;
    ...
    :goto_0
    invoke-virtual {v1}, Lio/ktor/util/internal/d;->j()Lio/ktor/util/internal/f;
...
.method public i()Z
    ...
    invoke-virtual {p0, v1}, Lio/ktor/util/internal/d;->d(Lio/ktor/util/internal/d;)V
...
.method public final j()Lio/ktor/util/internal/f;
    .locals 2
    ...
    sget-object v1, Lio/ktor/util/internal/d;->e:Ljava/util/concurrent/atomic/AtomicReferenceFieldUpdater;
...
.method public toString()Ljava/lang/String;
    ...
    invoke-interface {v1}, Lkotlin/reflect/c;->getSimpleName()Ljava/lang/String;
