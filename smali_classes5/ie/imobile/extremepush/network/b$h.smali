.class public Lie/imobile/extremepush/network/b$h;
...
.method public constructor <init>(Lie/imobile/extremepush/network/b;Landroid/content/Context;Ljava/lang/String;Landroid/location/Location;)V
    ...
    iput-object p1, p0, Lie/imobile/extremepush/network/b$h;->e:Lie/imobile/extremepush/network/b;
    ...
    iput-object p3, p0, Lie/imobile/extremepush/network/b$h;->c:Ljava/lang/String;

    iput-object p4, p0, Lie/imobile/extremepush/network/b$h;->d:Landroid/location/Location;
...
.method public c()V
    ...
    :cond_0
    iget-object v0, p0, Lie/imobile/extremepush/network/b$h;->d:Landroid/location/Location;
    ...
    iput-object v0, p0, Lie/imobile/extremepush/network/b$h;->d:Landroid/location/Location;
    ...
    iget-object v4, p0, Lie/imobile/extremepush/network/b$h;->c:Ljava/lang/String;

    iget-object v5, p0, Lie/imobile/extremepush/network/b$h;->d:Landroid/location/Location;

    invoke-static {v3, v4, v5}, Lie/imobile/extremepush/network/p;->j(Landroid/content/Context;Ljava/lang/String;Landroid/location/Location;)Ljava/util/Map;
    ...
    iget-object v6, p0, Lie/imobile/extremepush/network/b$h;->c:Ljava/lang/String;
    ...
    iget-object v0, p0, Lie/imobile/extremepush/network/b$h;->c:Ljava/lang/String;

    iget-object v4, p0, Lie/imobile/extremepush/network/b$h;->d:Landroid/location/Location;

    invoke-static {v3, v2, v0, v4}, Lie/imobile/extremepush/network/z;->s(Landroid/content/Context;Lokhttp3/f;Ljava/lang/String;Landroid/location/Location;)V
    :try_end_0
    ...
    const-string v3, "Issue sending  location exit : "
