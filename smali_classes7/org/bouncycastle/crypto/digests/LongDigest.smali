...
# virtual methods
.method public abstract synthetic copy()Lorg/bouncycastle/util/e;
.end method
...
.method public populateState([B)V
    ...
    invoke-static {v0, p1, v1}, Lorg/bouncycastle/util/f;->f(I[BI)V

    iget-wide v0, p0, Lorg/bouncycastle/crypto/digests/LongDigest;->byteCount1:J

    const/16 v3, 0xc

    invoke-static {v0, v1, p1, v3}, Lorg/bouncycastle/util/f;->s(J[BI)V
    ...
    invoke-static {v3, v4, p1, v0}, Lorg/bouncycastle/util/f;->s(J[BI)V
...
.method public processWord([BI)V
    ...
    invoke-static {p1, p2}, Lorg/bouncycastle/util/f;->d([BI)J
...
.method public abstract synthetic reset(Lorg/bouncycastle/util/e;)V
.end method
...
.method public restoreState([B)V
    ...
    invoke-static {p1, v0}, Lorg/bouncycastle/util/f;->d([BI)J
    ...
    invoke-static {p1, v1}, Lorg/bouncycastle/util/f;->d([BI)J
