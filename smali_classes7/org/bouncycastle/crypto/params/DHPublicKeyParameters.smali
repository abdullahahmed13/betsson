...
.method private static legendre(Ljava/math/BigInteger;Ljava/math/BigInteger;)I
    ...
    invoke-static {v0, p0, v1}, Lorg/bouncycastle/math/raw/n;->I(I[II)I

    goto :goto_0

    :cond_0
    invoke-static {v3}, Lorg/bouncycastle/util/c;->b(I)I

    move-result v3

    if-lez v3, :cond_1

    invoke-static {v0, p0, v3, v1}, Lorg/bouncycastle/math/raw/n;->G(I[III)I
    ...
    :cond_1
    invoke-static {v0, p0, p1}, Lorg/bouncycastle/math/raw/n;->i(I[I[I)I

    move-result v3

    if-nez v3, :cond_3

    invoke-static {v0, p1}, Lorg/bouncycastle/math/raw/n;->z(I[I)Z
    ...
    :cond_5
    invoke-static {v0, p0, p1, p0}, Lorg/bouncycastle/math/raw/n;->Q(I[I[I[I)I
