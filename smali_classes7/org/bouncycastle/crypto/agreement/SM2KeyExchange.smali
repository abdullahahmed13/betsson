...
.field private ephemeralPubPoint:Lorg/bouncycastle/math/ec/i;

.field private initiator:Z

.field private staticKey:Lorg/bouncycastle/crypto/params/ECPrivateKeyParameters;

.field private staticPubPoint:Lorg/bouncycastle/math/ec/i;
...
.method private S1(Lorg/bouncycastle/crypto/Digest;Lorg/bouncycastle/math/ec/i;[B)[B
    .locals 1
    ...
    invoke-virtual {p2}, Lorg/bouncycastle/math/ec/i;->f()Lorg/bouncycastle/math/ec/f;

    move-result-object p2

    invoke-direct {p0, p1, p2}, Lorg/bouncycastle/crypto/agreement/SM2KeyExchange;->addFieldElement(Lorg/bouncycastle/crypto/Digest;Lorg/bouncycastle/math/ec/f;)V
...
.method private S2(Lorg/bouncycastle/crypto/Digest;Lorg/bouncycastle/math/ec/i;[B)[B
    .locals 1
...
.method private addFieldElement(Lorg/bouncycastle/crypto/Digest;Lorg/bouncycastle/math/ec/f;)V
    .locals 2

    invoke-virtual {p2}, Lorg/bouncycastle/math/ec/f;->e()[B
...
.method private calculateInnerHash(Lorg/bouncycastle/crypto/Digest;Lorg/bouncycastle/math/ec/i;[B[BLorg/bouncycastle/math/ec/i;Lorg/bouncycastle/math/ec/i;)[B
    .locals 1

    invoke-virtual {p2}, Lorg/bouncycastle/math/ec/i;->e()Lorg/bouncycastle/math/ec/f;
    ...
    invoke-virtual {p5}, Lorg/bouncycastle/math/ec/i;->e()Lorg/bouncycastle/math/ec/f;

    move-result-object p2

    invoke-direct {p0, p1, p2}, Lorg/bouncycastle/crypto/agreement/SM2KeyExchange;->addFieldElement(Lorg/bouncycastle/crypto/Digest;Lorg/bouncycastle/math/ec/f;)V

    invoke-virtual {p5}, Lorg/bouncycastle/math/ec/i;->f()Lorg/bouncycastle/math/ec/f;

    move-result-object p2

    invoke-direct {p0, p1, p2}, Lorg/bouncycastle/crypto/agreement/SM2KeyExchange;->addFieldElement(Lorg/bouncycastle/crypto/Digest;Lorg/bouncycastle/math/ec/f;)V

    invoke-virtual {p6}, Lorg/bouncycastle/math/ec/i;->e()Lorg/bouncycastle/math/ec/f;

    move-result-object p2

    invoke-direct {p0, p1, p2}, Lorg/bouncycastle/crypto/agreement/SM2KeyExchange;->addFieldElement(Lorg/bouncycastle/crypto/Digest;Lorg/bouncycastle/math/ec/f;)V

    invoke-virtual {p6}, Lorg/bouncycastle/math/ec/i;->f()Lorg/bouncycastle/math/ec/f;
...
.method private calculateU(Lorg/bouncycastle/crypto/params/SM2KeyExchangePublicParameters;)Lorg/bouncycastle/math/ec/i;
    .locals 5
    ...
    invoke-virtual {v2}, Lorg/bouncycastle/crypto/params/ECPublicKeyParameters;->getQ()Lorg/bouncycastle/math/ec/i;

    move-result-object v2

    invoke-static {v1, v2}, Lorg/bouncycastle/math/ec/c;->a(Lorg/bouncycastle/math/ec/e;Lorg/bouncycastle/math/ec/i;)Lorg/bouncycastle/math/ec/i;
    ...
    invoke-virtual {p1}, Lorg/bouncycastle/crypto/params/ECPublicKeyParameters;->getQ()Lorg/bouncycastle/math/ec/i;
    ...
    iget-object v0, p0, Lorg/bouncycastle/crypto/agreement/SM2KeyExchange;->ephemeralPubPoint:Lorg/bouncycastle/math/ec/i;
    ...
    invoke-virtual {p1}, Lorg/bouncycastle/math/ec/i;->e()Lorg/bouncycastle/math/ec/f;
    ...
    invoke-static {v1, v0, p1, v2}, Lorg/bouncycastle/math/ec/c;->r(Lorg/bouncycastle/math/ec/i;Ljava/math/BigInteger;Lorg/bouncycastle/math/ec/i;Ljava/math/BigInteger;)Lorg/bouncycastle/math/ec/i;
...
.method private getZ(Lorg/bouncycastle/crypto/Digest;[BLorg/bouncycastle/math/ec/i;)[B
    .locals 0
    ...
    invoke-virtual {p2}, Lorg/bouncycastle/math/ec/e;->n()Lorg/bouncycastle/math/ec/f;
    ...
    invoke-virtual {p2}, Lorg/bouncycastle/math/ec/e;->o()Lorg/bouncycastle/math/ec/f;
    ...
    invoke-virtual {p2}, Lorg/bouncycastle/crypto/params/ECDomainParameters;->getG()Lorg/bouncycastle/math/ec/i;
    ...
    invoke-virtual {p3}, Lorg/bouncycastle/math/ec/i;->e()Lorg/bouncycastle/math/ec/f;

    move-result-object p2

    invoke-direct {p0, p1, p2}, Lorg/bouncycastle/crypto/agreement/SM2KeyExchange;->addFieldElement(Lorg/bouncycastle/crypto/Digest;Lorg/bouncycastle/math/ec/f;)V

    invoke-virtual {p3}, Lorg/bouncycastle/math/ec/i;->f()Lorg/bouncycastle/math/ec/f;
...
.method private kdf(Lorg/bouncycastle/math/ec/i;[B[BI)[B
    .locals 11
    ...
    instance-of v5, v4, Lorg/bouncycastle/util/e;
    ...
    invoke-direct {p0, v4, v5}, Lorg/bouncycastle/crypto/agreement/SM2KeyExchange;->addFieldElement(Lorg/bouncycastle/crypto/Digest;Lorg/bouncycastle/math/ec/f;)V

    iget-object v4, p0, Lorg/bouncycastle/crypto/agreement/SM2KeyExchange;->digest:Lorg/bouncycastle/crypto/Digest;

    invoke-virtual {p1}, Lorg/bouncycastle/math/ec/i;->f()Lorg/bouncycastle/math/ec/f;
    ...
    check-cast v4, Lorg/bouncycastle/util/e;

    invoke-interface {v4}, Lorg/bouncycastle/util/e;->copy()Lorg/bouncycastle/util/e;
    ...
    invoke-interface {v4, v5}, Lorg/bouncycastle/util/e;->reset(Lorg/bouncycastle/util/e;)V
    ...
    invoke-direct {p0, v9, v10}, Lorg/bouncycastle/crypto/agreement/SM2KeyExchange;->addFieldElement(Lorg/bouncycastle/crypto/Digest;Lorg/bouncycastle/math/ec/f;)V
    ...
    invoke-static {v8, v2, v6}, Lorg/bouncycastle/util/f;->f(I[BI)V
...
.method public calculateKey(ILorg/bouncycastle/crypto/CipherParameters;)[B
    ...
    iget-object v3, p0, Lorg/bouncycastle/crypto/agreement/SM2KeyExchange;->staticPubPoint:Lorg/bouncycastle/math/ec/i;

    invoke-direct {p0, v1, v2, v3}, Lorg/bouncycastle/crypto/agreement/SM2KeyExchange;->getZ(Lorg/bouncycastle/crypto/Digest;[BLorg/bouncycastle/math/ec/i;)[B
    ...
    invoke-virtual {v3}, Lorg/bouncycastle/crypto/params/ECPublicKeyParameters;->getQ()Lorg/bouncycastle/math/ec/i;

    move-result-object v3

    invoke-direct {p0, v2, p2, v3}, Lorg/bouncycastle/crypto/agreement/SM2KeyExchange;->getZ(Lorg/bouncycastle/crypto/Digest;[BLorg/bouncycastle/math/ec/i;)[B

    move-result-object p2

    invoke-direct {p0, v0}, Lorg/bouncycastle/crypto/agreement/SM2KeyExchange;->calculateU(Lorg/bouncycastle/crypto/params/SM2KeyExchangePublicParameters;)Lorg/bouncycastle/math/ec/i;
    ...
    invoke-direct {p0, v0, v1, p2, p1}, Lorg/bouncycastle/crypto/agreement/SM2KeyExchange;->kdf(Lorg/bouncycastle/math/ec/i;[B[BI)[B
    ...
    :cond_1
    invoke-direct {p0, v0, p2, v1, p1}, Lorg/bouncycastle/crypto/agreement/SM2KeyExchange;->kdf(Lorg/bouncycastle/math/ec/i;[B[BI)[B
...
.method public calculateKeyWithConfirmation(I[BLorg/bouncycastle/crypto/CipherParameters;)[[B
    ...
    invoke-direct {p0, v1, p3, v2}, Lorg/bouncycastle/crypto/agreement/SM2KeyExchange;->getZ(Lorg/bouncycastle/crypto/Digest;[BLorg/bouncycastle/math/ec/i;)[B
    ...
    invoke-direct {p0, v6, v7, v8, p1}, Lorg/bouncycastle/crypto/agreement/SM2KeyExchange;->kdf(Lorg/bouncycastle/math/ec/i;[B[BI)[B

    move-result-object p1

    iget-object v5, p0, Lorg/bouncycastle/crypto/agreement/SM2KeyExchange;->digest:Lorg/bouncycastle/crypto/Digest;

    iget-object v9, p0, Lorg/bouncycastle/crypto/agreement/SM2KeyExchange;->ephemeralPubPoint:Lorg/bouncycastle/math/ec/i;
    ...
    invoke-virtual {p3}, Lorg/bouncycastle/crypto/params/ECPublicKeyParameters;->getQ()Lorg/bouncycastle/math/ec/i;

    move-result-object v10

    move-object v4, p0

    invoke-direct/range {v4 .. v10}, Lorg/bouncycastle/crypto/agreement/SM2KeyExchange;->calculateInnerHash(Lorg/bouncycastle/crypto/Digest;Lorg/bouncycastle/math/ec/i;[B[BLorg/bouncycastle/math/ec/i;Lorg/bouncycastle/math/ec/i;)[B

    move-result-object p3

    iget-object v0, v4, Lorg/bouncycastle/crypto/agreement/SM2KeyExchange;->digest:Lorg/bouncycastle/crypto/Digest;

    invoke-direct {p0, v0, v6, p3}, Lorg/bouncycastle/crypto/agreement/SM2KeyExchange;->S1(Lorg/bouncycastle/crypto/Digest;Lorg/bouncycastle/math/ec/i;[B)[B

    move-result-object v0

    invoke-static {v0, p2}, Lorg/bouncycastle/util/a;->q([B[B)Z
    ...
    invoke-direct {p0, p2, v6, p3}, Lorg/bouncycastle/crypto/agreement/SM2KeyExchange;->S2(Lorg/bouncycastle/crypto/Digest;Lorg/bouncycastle/math/ec/i;[B)[B
    ...
    invoke-direct {p0, v6, v8, v7, p1}, Lorg/bouncycastle/crypto/agreement/SM2KeyExchange;->kdf(Lorg/bouncycastle/math/ec/i;[B[BI)[B
    ...
    invoke-virtual {p2}, Lorg/bouncycastle/crypto/params/ECPublicKeyParameters;->getQ()Lorg/bouncycastle/math/ec/i;

    move-result-object v9

    iget-object v10, v4, Lorg/bouncycastle/crypto/agreement/SM2KeyExchange;->ephemeralPubPoint:Lorg/bouncycastle/math/ec/i;
    ...
    invoke-direct {p0, p3, v6, p2}, Lorg/bouncycastle/crypto/agreement/SM2KeyExchange;->S1(Lorg/bouncycastle/crypto/Digest;Lorg/bouncycastle/math/ec/i;[B)[B

    move-result-object p3

    iget-object v0, v4, Lorg/bouncycastle/crypto/agreement/SM2KeyExchange;->digest:Lorg/bouncycastle/crypto/Digest;

    invoke-direct {p0, v0, v6, p2}, Lorg/bouncycastle/crypto/agreement/SM2KeyExchange;->S2(Lorg/bouncycastle/crypto/Digest;Lorg/bouncycastle/math/ec/i;[B)[B
...
.method public init(Lorg/bouncycastle/crypto/CipherParameters;)V
    ...
    invoke-virtual {v0}, Lorg/bouncycastle/crypto/params/SM2KeyExchangePrivateParameters;->getStaticPublicPoint()Lorg/bouncycastle/math/ec/i;

    move-result-object p1

    iput-object p1, p0, Lorg/bouncycastle/crypto/agreement/SM2KeyExchange;->staticPubPoint:Lorg/bouncycastle/math/ec/i;

    invoke-virtual {v0}, Lorg/bouncycastle/crypto/params/SM2KeyExchangePrivateParameters;->getEphemeralPublicPoint()Lorg/bouncycastle/math/ec/i;

    move-result-object p1

    iput-object p1, p0, Lorg/bouncycastle/crypto/agreement/SM2KeyExchange;->ephemeralPubPoint:Lorg/bouncycastle/math/ec/i;
    ...
    invoke-virtual {p1}, Lorg/bouncycastle/crypto/params/ECDomainParameters;->getCurve()Lorg/bouncycastle/math/ec/e;

    move-result-object p1

    invoke-virtual {p1}, Lorg/bouncycastle/math/ec/e;->t()I
