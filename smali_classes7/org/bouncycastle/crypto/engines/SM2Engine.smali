...
.method private decrypt([BII)[B
    ...
    invoke-virtual {v3}, Lorg/bouncycastle/crypto/params/ECDomainParameters;->getCurve()Lorg/bouncycastle/math/ec/e;

    move-result-object v3

    invoke-virtual {v3, v1}, Lorg/bouncycastle/math/ec/e;->j([B)Lorg/bouncycastle/math/ec/i;
    ...
    invoke-virtual {v3, v4}, Lorg/bouncycastle/math/ec/i;->w(Ljava/math/BigInteger;)Lorg/bouncycastle/math/ec/i;
    ...
    invoke-virtual {v3}, Lorg/bouncycastle/math/ec/i;->y()Lorg/bouncycastle/math/ec/i;
    ...
    invoke-direct {p0, v4, v3, v5}, Lorg/bouncycastle/crypto/engines/SM2Engine;->kdf(Lorg/bouncycastle/crypto/Digest;Lorg/bouncycastle/math/ec/i;[B)V
    ...
    invoke-direct {p0, v8, v9}, Lorg/bouncycastle/crypto/engines/SM2Engine;->addFieldElement(Lorg/bouncycastle/crypto/Digest;Lorg/bouncycastle/math/ec/f;)V
    ...
    invoke-virtual {v3}, Lorg/bouncycastle/math/ec/i;->f()Lorg/bouncycastle/math/ec/f;

    move-result-object v3

    invoke-direct {p0, v8, v3}, Lorg/bouncycastle/crypto/engines/SM2Engine;->addFieldElement(Lorg/bouncycastle/crypto/Digest;Lorg/bouncycastle/math/ec/f;)V
    ...
    :cond_2
    invoke-static {v1, v2}, Lorg/bouncycastle/util/a;->v([BB)V

    invoke-static {v6, v2}, Lorg/bouncycastle/util/a;->v([BB)V
    ...
    :cond_3
    invoke-static {v5, v2}, Lorg/bouncycastle/util/a;->v([BB)V
...
.method private encrypt([BII)[B
    ...
    invoke-virtual {p0}, Lorg/bouncycastle/crypto/engines/SM2Engine;->createBasePointMultiplier()Lorg/bouncycastle/math/ec/h;
    ...
    invoke-virtual {v4}, Lorg/bouncycastle/crypto/params/ECDomainParameters;->getG()Lorg/bouncycastle/math/ec/i;

    move-result-object v4

    invoke-interface {v2, v4, v3}, Lorg/bouncycastle/math/ec/h;->a(Lorg/bouncycastle/math/ec/i;Ljava/math/BigInteger;)Lorg/bouncycastle/math/ec/i;

    move-result-object v4

    invoke-virtual {v4}, Lorg/bouncycastle/math/ec/i;->y()Lorg/bouncycastle/math/ec/i;

    move-result-object v4

    invoke-virtual {v4, v1}, Lorg/bouncycastle/math/ec/i;->j(Z)[B
    ...
    invoke-virtual {v5}, Lorg/bouncycastle/crypto/params/ECPublicKeyParameters;->getQ()Lorg/bouncycastle/math/ec/i;

    move-result-object v5

    invoke-virtual {v5, v3}, Lorg/bouncycastle/math/ec/i;->w(Ljava/math/BigInteger;)Lorg/bouncycastle/math/ec/i;
    ...
    invoke-direct {p0, v5, v3, v0}, Lorg/bouncycastle/crypto/engines/SM2Engine;->kdf(Lorg/bouncycastle/crypto/Digest;Lorg/bouncycastle/math/ec/i;[B)V
    ...
    invoke-direct {p0, v5, v6}, Lorg/bouncycastle/crypto/engines/SM2Engine;->addFieldElement(Lorg/bouncycastle/crypto/Digest;Lorg/bouncycastle/math/ec/f;)V
    ...
    invoke-direct {p0, p1, p2}, Lorg/bouncycastle/crypto/engines/SM2Engine;->addFieldElement(Lorg/bouncycastle/crypto/Digest;Lorg/bouncycastle/math/ec/f;)V
    ...
    invoke-static {v4, v0, v2}, Lorg/bouncycastle/util/a;->n([B[B[B)[B
    ...
    :cond_1
    invoke-static {v4, v2, v0}, Lorg/bouncycastle/util/a;->n([B[B[B)[B
...
.method private kdf(Lorg/bouncycastle/crypto/Digest;Lorg/bouncycastle/math/ec/i;[B)V
    .locals 9
    ...
    instance-of v3, p1, Lorg/bouncycastle/util/e;
    ...
    invoke-direct {p0, p1, v3}, Lorg/bouncycastle/crypto/engines/SM2Engine;->addFieldElement(Lorg/bouncycastle/crypto/Digest;Lorg/bouncycastle/math/ec/f;)V
    ...
    check-cast v3, Lorg/bouncycastle/util/e;

    invoke-interface {v3}, Lorg/bouncycastle/util/e;->copy()Lorg/bouncycastle/util/e;
    ...
    invoke-interface {v3, v4}, Lorg/bouncycastle/util/e;->reset(Lorg/bouncycastle/util/e;)V
    ...
    invoke-direct {p0, p1, v8}, Lorg/bouncycastle/crypto/engines/SM2Engine;->addFieldElement(Lorg/bouncycastle/crypto/Digest;Lorg/bouncycastle/math/ec/f;)V
    ...
    invoke-static {v7, v2, v5}, Lorg/bouncycastle/util/f;->f(I[BI)V
...
.method private nextK()Ljava/math/BigInteger;
    ...
    invoke-static {v0, v1}, Lorg/bouncycastle/util/b;->e(ILjava/security/SecureRandom;)Ljava/math/BigInteger;
...
# virtual methods
.method public createBasePointMultiplier()Lorg/bouncycastle/math/ec/h;
    .locals 1
...
.method public init(ZLorg/bouncycastle/crypto/CipherParameters;)V
    ...
    invoke-virtual {p1, v0}, Lorg/bouncycastle/math/ec/i;->w(Ljava/math/BigInteger;)Lorg/bouncycastle/math/ec/i;
