...
.method public decryptBlock([J[J)V
    ...
    aget-wide v30, v61, v58

    sub-long v13, v13, v30

    aget-wide v30, v61, v59

    sub-long v11, v11, v30

    aget-wide v30, v61, v60
...
.method public encryptBlock([J[J)V
    ...
    invoke-static {v6, v7, v13, v11, v12}, Lorg/bouncycastle/crypto/engines/ThreefishEngine;->rotlXor(JIJ)J
    ...
    invoke-static {v4, v5, v15, v11, v12}, Lorg/bouncycastle/crypto/engines/ThreefishEngine;->rotlXor(JIJ)J
    ...
    invoke-static {v8, v9, v15, v11, v12}, Lorg/bouncycastle/crypto/engines/ThreefishEngine;->rotlXor(JIJ)J
    ...
    add-int/lit8 v61, v27, 0x2

    aget-wide v62, v45, v61

    add-long v39, v39, v62

    add-int/lit8 v62, v27, 0x3

    aget-wide v63, v45, v62

    add-long v2, v2, v63

    add-int/lit8 v63, v27, 0x4

    aget-wide v64, v45, v63

    add-long v53, v53, v64

    add-int/lit8 v64, v27, 0x5

    aget-wide v65, v45, v64

    add-long v14, v48, v65

    add-int/lit8 v48, v27, 0x6

    aget-wide v65, v45, v48

    add-long v6, v6, v65

    add-int/lit8 v49, v27, 0x7

    aget-wide v65, v45, v49
    ...
    add-int/lit8 v58, v27, 0xc

    aget-wide v70, v45, v58

    add-long v12, v12, v70

    add-int/lit8 v59, v27, 0xd

    aget-wide v70, v45, v59
    ...
    add-long v55, v55, v70

    add-int/lit8 v70, v27, 0xf

    aget-wide v76, v45, v70
    ...
    invoke-static {v4, v5, v10, v12, v13}, Lorg/bouncycastle/crypto/engines/ThreefishEngine;->rotlXor(JIJ)J
    ...
    invoke-static {v1, v2, v0, v8, v9}, Lorg/bouncycastle/crypto/engines/ThreefishEngine;->rotlXor(JIJ)J
    ...
    aget-wide v4, v45, v60

    add-long/2addr v4, v14

    aget-wide v14, v45, v61

    add-long v14, v55, v14

    aget-wide v55, v45, v62

    add-long v12, v12, v55

    aget-wide v55, v45, v63

    add-long v42, v42, v55

    aget-wide v55, v45, v64

    add-long v55, v74, v55

    aget-wide v60, v45, v48
    ...
    aget-wide v39, v45, v58

    add-long v63, v36, v39

    aget-wide v36, v45, v59

    add-long v2, v2, v36

    aget-wide v36, v45, v24

    aget-wide v24, v46, v25

    add-long v36, v36, v24

    add-long v65, v53, v36

    aget-wide v24, v45, v70

    add-int/lit8 v28, v28, 0x2

    aget-wide v36, v46, v28

    add-long v24, v24, v36

    add-long v48, v21, v24
    ...
    aput-wide v11, p2, v29

    aput-wide v27, p2, v32
