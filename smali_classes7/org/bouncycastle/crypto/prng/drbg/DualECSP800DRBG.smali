...
# instance fields
.field private _P:Lorg/bouncycastle/math/ec/i;

.field private _Q:Lorg/bouncycastle/math/ec/i;

.field private _curve:Lorg/bouncycastle/math/ec/e$f;
...
.field private _fixedPointMultiplier:Lorg/bouncycastle/math/ec/h;
...
.method static constructor <clinit>()V
    ...
    invoke-static {v13}, Lorg/bouncycastle/asn1/nist/a;->b(Ljava/lang/String;)Lorg/bouncycastle/asn1/x9/h;

    move-result-object v13

    invoke-virtual {v13}, Lorg/bouncycastle/asn1/x9/h;->h()Lorg/bouncycastle/math/ec/e;

    move-result-object v13

    check-cast v13, Lorg/bouncycastle/math/ec/e$f;

    new-instance v14, Lorg/bouncycastle/crypto/prng/drbg/DualECPoints;

    invoke-virtual {v13, v0, v1}, Lorg/bouncycastle/math/ec/e;->g(Ljava/math/BigInteger;Ljava/math/BigInteger;)Lorg/bouncycastle/math/ec/i;

    move-result-object v0

    invoke-virtual {v13, v3, v4}, Lorg/bouncycastle/math/ec/e;->g(Ljava/math/BigInteger;Ljava/math/BigInteger;)Lorg/bouncycastle/math/ec/i;
    ...
    invoke-direct {v14, v3, v0, v1, v4}, Lorg/bouncycastle/crypto/prng/drbg/DualECPoints;-><init>(ILorg/bouncycastle/math/ec/i;Lorg/bouncycastle/math/ec/i;I)V
    ...
    invoke-static {v0}, Lorg/bouncycastle/asn1/nist/a;->b(Ljava/lang/String;)Lorg/bouncycastle/asn1/x9/h;
    ...
    check-cast v0, Lorg/bouncycastle/math/ec/e$f;

    new-instance v1, Lorg/bouncycastle/crypto/prng/drbg/DualECPoints;

    invoke-virtual {v0, v5, v6}, Lorg/bouncycastle/math/ec/e;->g(Ljava/math/BigInteger;Ljava/math/BigInteger;)Lorg/bouncycastle/math/ec/i;

    move-result-object v3

    invoke-virtual {v0, v7, v8}, Lorg/bouncycastle/math/ec/e;->g(Ljava/math/BigInteger;Ljava/math/BigInteger;)Lorg/bouncycastle/math/ec/i;

    move-result-object v0

    const/16 v5, 0xc0

    invoke-direct {v1, v5, v3, v0, v4}, Lorg/bouncycastle/crypto/prng/drbg/DualECPoints;-><init>(ILorg/bouncycastle/math/ec/i;Lorg/bouncycastle/math/ec/i;I)V
    ...
    invoke-virtual {v0, v9, v10}, Lorg/bouncycastle/math/ec/e;->g(Ljava/math/BigInteger;Ljava/math/BigInteger;)Lorg/bouncycastle/math/ec/i;

    move-result-object v3

    invoke-virtual {v0, v11, v12}, Lorg/bouncycastle/math/ec/e;->g(Ljava/math/BigInteger;Ljava/math/BigInteger;)Lorg/bouncycastle/math/ec/i;
...
.method public constructor <init>([Lorg/bouncycastle/crypto/prng/drbg/DualECPoints;Lorg/bouncycastle/crypto/Digest;ILorg/bouncycastle/crypto/prng/EntropySource;[B[B)V
    ...
    new-instance v0, Lorg/bouncycastle/math/ec/k;

    invoke-direct {v0}, Lorg/bouncycastle/math/ec/k;-><init>()V

    iput-object v0, p0, Lorg/bouncycastle/crypto/prng/drbg/DualECSP800DRBG;->_fixedPointMultiplier:Lorg/bouncycastle/math/ec/h;
    ...
    invoke-static {p4, p6, p5}, Lorg/bouncycastle/util/a;->n([B[B[B)[B
    ...
    invoke-virtual {p2}, Lorg/bouncycastle/crypto/prng/drbg/DualECPoints;->getP()Lorg/bouncycastle/math/ec/i;

    move-result-object p2

    iput-object p2, p0, Lorg/bouncycastle/crypto/prng/drbg/DualECSP800DRBG;->_P:Lorg/bouncycastle/math/ec/i;

    aget-object p1, p1, p5

    invoke-virtual {p1}, Lorg/bouncycastle/crypto/prng/drbg/DualECPoints;->getQ()Lorg/bouncycastle/math/ec/i;

    move-result-object p1

    iput-object p1, p0, Lorg/bouncycastle/crypto/prng/drbg/DualECSP800DRBG;->_Q:Lorg/bouncycastle/math/ec/i;
    ...
    :cond_2
    :goto_1
    iget-object p1, p0, Lorg/bouncycastle/crypto/prng/drbg/DualECSP800DRBG;->_P:Lorg/bouncycastle/math/ec/i;
...
.method private getScalarMultipleXCoord(Lorg/bouncycastle/math/ec/i;Ljava/math/BigInteger;)Ljava/math/BigInteger;
    .locals 1

    iget-object v0, p0, Lorg/bouncycastle/crypto/prng/drbg/DualECSP800DRBG;->_fixedPointMultiplier:Lorg/bouncycastle/math/ec/h;

    invoke-interface {v0, p1, p2}, Lorg/bouncycastle/math/ec/h;->a(Lorg/bouncycastle/math/ec/i;Ljava/math/BigInteger;)Lorg/bouncycastle/math/ec/i;
...
.method public generate([B[BZ)I
    ...
    invoke-static {p1, p2}, Lorg/bouncycastle/util/a;->v([BB)V
    ...
    iget-object v6, p0, Lorg/bouncycastle/crypto/prng/drbg/DualECSP800DRBG;->_P:Lorg/bouncycastle/math/ec/i;

    invoke-direct {p0, v6, v2}, Lorg/bouncycastle/crypto/prng/drbg/DualECSP800DRBG;->getScalarMultipleXCoord(Lorg/bouncycastle/math/ec/i;Ljava/math/BigInteger;)Ljava/math/BigInteger;

    move-result-object v2

    iget-object v6, p0, Lorg/bouncycastle/crypto/prng/drbg/DualECSP800DRBG;->_Q:Lorg/bouncycastle/math/ec/i;
    ...
    iget-object p3, p0, Lorg/bouncycastle/crypto/prng/drbg/DualECSP800DRBG;->_P:Lorg/bouncycastle/math/ec/i;

    invoke-direct {p0, p3, v2}, Lorg/bouncycastle/crypto/prng/drbg/DualECSP800DRBG;->getScalarMultipleXCoord(Lorg/bouncycastle/math/ec/i;Ljava/math/BigInteger;)Ljava/math/BigInteger;

    move-result-object v2

    iget-object p3, p0, Lorg/bouncycastle/crypto/prng/drbg/DualECSP800DRBG;->_Q:Lorg/bouncycastle/math/ec/i;
    ...
    iget-object p2, p0, Lorg/bouncycastle/crypto/prng/drbg/DualECSP800DRBG;->_P:Lorg/bouncycastle/math/ec/i;

    invoke-direct {p0, p2, v2}, Lorg/bouncycastle/crypto/prng/drbg/DualECSP800DRBG;->getScalarMultipleXCoord(Lorg/bouncycastle/math/ec/i;Ljava/math/BigInteger;)Ljava/math/BigInteger;
...
.method public reseed([B)V
    ...
    invoke-static {v1, v0, p1}, Lorg/bouncycastle/util/a;->n([B[B[B)[B
