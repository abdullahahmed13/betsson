...
.method private processBlock()V
    ...
    invoke-static {v1, v2}, Lorg/bouncycastle/util/f;->m([BI)I
    ...
    invoke-static {v8, v9}, Lorg/bouncycastle/util/f;->m([BI)I
    ...
    invoke-static {v10, v11}, Lorg/bouncycastle/util/f;->m([BI)I
    ...
    invoke-static {v10, v14}, Lorg/bouncycastle/util/f;->m([BI)I
...
.method private setKey([B[B)V
    ...
    invoke-static {p1, v0}, Lorg/bouncycastle/util/f;->m([BI)I

    move-result v2

    const/4 v3, 0x4

    invoke-static {p1, v3}, Lorg/bouncycastle/util/f;->m([BI)I

    move-result v3

    const/16 v4, 0x8

    invoke-static {p1, v4}, Lorg/bouncycastle/util/f;->m([BI)I

    move-result v5

    const/16 v6, 0xc

    invoke-static {p1, v6}, Lorg/bouncycastle/util/f;->m([BI)I
    ...
    :goto_1
    invoke-static {p1, v1}, Lorg/bouncycastle/util/f;->m([BI)I
    ...
    invoke-static {p1, p2}, Lorg/bouncycastle/util/f;->m([BI)I
...
.method public doFinal([BI)I
    ...
    invoke-static {v4, p1, p2}, Lorg/bouncycastle/util/f;->j(I[BI)V
    ...
    invoke-static {v5, p1, v6}, Lorg/bouncycastle/util/f;->j(I[BI)V
    ...
    invoke-static {v0, p1, v1}, Lorg/bouncycastle/util/f;->j(I[BI)V
    ...
    invoke-static {v0, p1, p2}, Lorg/bouncycastle/util/f;->j(I[BI)V
