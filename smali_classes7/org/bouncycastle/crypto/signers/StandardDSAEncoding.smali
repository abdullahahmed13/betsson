...
.method public decode(Ljava/math/BigInteger;[B)[Ljava/math/BigInteger;
    ...
    invoke-static {p2}, Lorg/bouncycastle/asn1/r;->l([B)Lorg/bouncycastle/asn1/r;
    ...
    invoke-virtual {p0, p1, v0, v1}, Lorg/bouncycastle/crypto/signers/StandardDSAEncoding;->decodeValue(Ljava/math/BigInteger;Lorg/bouncycastle/asn1/s;I)Ljava/math/BigInteger;

    move-result-object v1

    const/4 v2, 0x1

    invoke-virtual {p0, p1, v0, v2}, Lorg/bouncycastle/crypto/signers/StandardDSAEncoding;->decodeValue(Ljava/math/BigInteger;Lorg/bouncycastle/asn1/s;I)Ljava/math/BigInteger;
    ...
    invoke-static {p1, p2}, Lorg/bouncycastle/util/a;->c([B[B)Z
...
.method public decodeValue(Ljava/math/BigInteger;Lorg/bouncycastle/asn1/s;I)Ljava/math/BigInteger;
    .locals 0

    invoke-virtual {p2, p3}, Lorg/bouncycastle/asn1/s;->q(I)Lorg/bouncycastle/asn1/e;
...
.method public encode(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;)[B
    ...
    invoke-virtual {p0, p1, v0, p2}, Lorg/bouncycastle/crypto/signers/StandardDSAEncoding;->encodeValue(Ljava/math/BigInteger;Lorg/bouncycastle/asn1/f;Ljava/math/BigInteger;)V

    invoke-virtual {p0, p1, v0, p3}, Lorg/bouncycastle/crypto/signers/StandardDSAEncoding;->encodeValue(Ljava/math/BigInteger;Lorg/bouncycastle/asn1/f;Ljava/math/BigInteger;)V
    ...
    invoke-virtual {p1, p2}, Lorg/bouncycastle/asn1/m;->g(Ljava/lang/String;)[B
...
.method public encodeValue(Ljava/math/BigInteger;Lorg/bouncycastle/asn1/f;Ljava/math/BigInteger;)V
    .locals 1
