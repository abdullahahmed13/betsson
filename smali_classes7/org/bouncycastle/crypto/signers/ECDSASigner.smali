...
.method public generateSignature([B)[Ljava/math/BigInteger;
    ...
    :goto_0
    invoke-virtual {p0}, Lorg/bouncycastle/crypto/signers/ECDSASigner;->createBasePointMultiplier()Lorg/bouncycastle/math/ec/h;
    ...
    invoke-interface {p1, v5, v4}, Lorg/bouncycastle/math/ec/h;->a(Lorg/bouncycastle/math/ec/i;Ljava/math/BigInteger;)Lorg/bouncycastle/math/ec/i;
    ...
    invoke-static {v1, v4}, Lorg/bouncycastle/util/b;->j(Ljava/math/BigInteger;Ljava/math/BigInteger;)Ljava/math/BigInteger;
...
.method public getDenominator(ILorg/bouncycastle/math/ec/i;)Lorg/bouncycastle/math/ec/f;
    .locals 2
    ...
    :cond_0
    invoke-virtual {p2, v1}, Lorg/bouncycastle/math/ec/i;->q(I)Lorg/bouncycastle/math/ec/f;
...
.method public verifySignature([BLjava/math/BigInteger;Ljava/math/BigInteger;)Z
    ...
    :cond_1
    invoke-static {v1, p3}, Lorg/bouncycastle/util/b;->k(Ljava/math/BigInteger;Ljava/math/BigInteger;)Ljava/math/BigInteger;
    ...
    invoke-static {v0, p1, v2, p3}, Lorg/bouncycastle/math/ec/c;->r(Lorg/bouncycastle/math/ec/i;Ljava/math/BigInteger;Lorg/bouncycastle/math/ec/i;Ljava/math/BigInteger;)Lorg/bouncycastle/math/ec/i;
    ...
    invoke-virtual {p3}, Lorg/bouncycastle/math/ec/e;->p()Ljava/math/BigInteger;

    move-result-object v0

    if-eqz v0, :cond_5

    sget-object v2, Lorg/bouncycastle/math/ec/d;->f:Ljava/math/BigInteger;
    ...
    invoke-virtual {p3}, Lorg/bouncycastle/math/ec/e;->q()I

    move-result v0

    invoke-virtual {p0, v0, p1}, Lorg/bouncycastle/crypto/signers/ECDSASigner;->getDenominator(ILorg/bouncycastle/math/ec/i;)Lorg/bouncycastle/math/ec/f;
    ...
    :goto_0
    invoke-virtual {p3, p2}, Lorg/bouncycastle/math/ec/e;->y(Ljava/math/BigInteger;)Z

    move-result v2

    if-eqz v2, :cond_4

    invoke-virtual {p3, p2}, Lorg/bouncycastle/math/ec/e;->m(Ljava/math/BigInteger;)Lorg/bouncycastle/math/ec/f;
