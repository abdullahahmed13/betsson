...
.field private pubPoint:Lorg/bouncycastle/math/ec/i;
...
.method private getZ([B)[B
    ...
    invoke-direct {p0, p1, v0}, Lorg/bouncycastle/crypto/signers/SM2Signer;->addFieldElement(Lorg/bouncycastle/crypto/Digest;Lorg/bouncycastle/math/ec/f;)V
    ...
    iget-object v0, p0, Lorg/bouncycastle/crypto/signers/SM2Signer;->pubPoint:Lorg/bouncycastle/math/ec/i;
...
.method private verifySignature(Ljava/math/BigInteger;Ljava/math/BigInteger;)Z
    ...
    sget-object v4, Lorg/bouncycastle/math/ec/d;->a:Ljava/math/BigInteger;
    ...
    invoke-virtual {v4}, Lorg/bouncycastle/crypto/params/ECPublicKeyParameters;->getQ()Lorg/bouncycastle/math/ec/i;
    ...
    invoke-virtual {v5}, Lorg/bouncycastle/crypto/params/ECDomainParameters;->getG()Lorg/bouncycastle/math/ec/i;

    move-result-object v5

    invoke-static {v5, p2, v4, v2}, Lorg/bouncycastle/math/ec/c;->r(Lorg/bouncycastle/math/ec/i;Ljava/math/BigInteger;Lorg/bouncycastle/math/ec/i;Ljava/math/BigInteger;)Lorg/bouncycastle/math/ec/i;

    move-result-object p2

    invoke-virtual {p2}, Lorg/bouncycastle/math/ec/i;->y()Lorg/bouncycastle/math/ec/i;

    move-result-object p2

    invoke-virtual {p2}, Lorg/bouncycastle/math/ec/i;->s()Z
...
.method public generateSignature()[B
    ...
    invoke-virtual {p0}, Lorg/bouncycastle/crypto/signers/SM2Signer;->createBasePointMultiplier()Lorg/bouncycastle/math/ec/h;
    ...
    invoke-interface {v3, v5, v4}, Lorg/bouncycastle/math/ec/h;->a(Lorg/bouncycastle/math/ec/i;Ljava/math/BigInteger;)Lorg/bouncycastle/math/ec/i;

    move-result-object v5

    invoke-virtual {v5}, Lorg/bouncycastle/math/ec/i;->y()Lorg/bouncycastle/math/ec/i;

    move-result-object v5

    invoke-virtual {v5}, Lorg/bouncycastle/math/ec/i;->e()Lorg/bouncycastle/math/ec/f;
    ...
    sget-object v6, Lorg/bouncycastle/math/ec/d;->a:Ljava/math/BigInteger;
    ...
    sget-object v7, Lorg/bouncycastle/math/ec/d;->b:Ljava/math/BigInteger;

    invoke-virtual {v2, v7}, Ljava/math/BigInteger;->add(Ljava/math/BigInteger;)Ljava/math/BigInteger;

    move-result-object v7

    invoke-static {v1, v7}, Lorg/bouncycastle/util/b;->j(Ljava/math/BigInteger;Ljava/math/BigInteger;)Ljava/math/BigInteger;
...
.method public init(ZLorg/bouncycastle/crypto/CipherParameters;)V
    ...
    invoke-interface {p1, p2, v1}, Lorg/bouncycastle/math/ec/h;->a(Lorg/bouncycastle/math/ec/i;Ljava/math/BigInteger;)Lorg/bouncycastle/math/ec/i;
    ...
    :goto_2
    iput-object p1, p0, Lorg/bouncycastle/crypto/signers/SM2Signer;->pubPoint:Lorg/bouncycastle/math/ec/i;
