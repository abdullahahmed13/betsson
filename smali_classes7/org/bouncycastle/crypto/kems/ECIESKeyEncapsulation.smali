...
.method public decrypt([BIII)Lorg/bouncycastle/crypto/CipherParameters;
    ...
    invoke-virtual {v1}, Lorg/bouncycastle/crypto/params/ECDomainParameters;->getCurve()Lorg/bouncycastle/math/ec/e;
    ...
    invoke-virtual {v2, v5}, Lorg/bouncycastle/math/ec/e;->j([B)Lorg/bouncycastle/math/ec/i;
    ...
    :cond_0
    invoke-virtual {p1, v4}, Lorg/bouncycastle/math/ec/i;->w(Ljava/math/BigInteger;)Lorg/bouncycastle/math/ec/i;
    ...
    :cond_2
    invoke-virtual {p1, p2}, Lorg/bouncycastle/math/ec/i;->w(Ljava/math/BigInteger;)Lorg/bouncycastle/math/ec/i;
...
.method public deriveKey(I[B[B)Lorg/bouncycastle/crypto/params/KeyParameter;
    ...
    invoke-static {p2, p3}, Lorg/bouncycastle/util/a;->m([B[B)[B

    move-result-object p2

    invoke-static {p3, v1}, Lorg/bouncycastle/util/a;->v([BB)V
...
.method public encrypt([BII)Lorg/bouncycastle/crypto/CipherParameters;
    ...
    invoke-static {v5, v3, v6}, Lorg/bouncycastle/util/b;->f(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/security/SecureRandom;)Ljava/math/BigInteger;
    ...
    :goto_0
    invoke-virtual {p0}, Lorg/bouncycastle/crypto/kems/ECIESKeyEncapsulation;->createBasePointMultiplier()Lorg/bouncycastle/math/ec/h;

    move-result-object v4

    invoke-virtual {v1}, Lorg/bouncycastle/crypto/params/ECDomainParameters;->getG()Lorg/bouncycastle/math/ec/i;

    move-result-object v1

    invoke-interface {v4, v1, v5}, Lorg/bouncycastle/math/ec/h;->a(Lorg/bouncycastle/math/ec/i;Ljava/math/BigInteger;)Lorg/bouncycastle/math/ec/i;

    move-result-object v1

    invoke-virtual {v0}, Lorg/bouncycastle/crypto/params/ECPublicKeyParameters;->getQ()Lorg/bouncycastle/math/ec/i;

    move-result-object v0

    invoke-virtual {v0, v3}, Lorg/bouncycastle/math/ec/i;->w(Ljava/math/BigInteger;)Lorg/bouncycastle/math/ec/i;

    move-result-object v0

    filled-new-array {v1, v0}, [Lorg/bouncycastle/math/ec/i;
    ...
    invoke-virtual {v2, v1}, Lorg/bouncycastle/math/ec/i;->j(Z)[B
    ...
    invoke-virtual {p0, p3, v2, p1}, Lorg/bouncycastle/crypto/kems/ECIESKeyEncapsulation;->deriveKey(I[B[B)Lorg/bouncycastle/crypto/params/KeyParameter;
