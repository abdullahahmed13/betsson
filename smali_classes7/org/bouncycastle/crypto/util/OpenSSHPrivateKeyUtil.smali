...
.method private static allIntegers(Lorg/bouncycastle/asn1/s;)Z
    .locals 3
...
.method public static encodePrivateKey(Lorg/bouncycastle/crypto/params/AsymmetricKeyParameter;)[B
    ...
    invoke-static {p0}, Lorg/bouncycastle/crypto/util/PrivateKeyInfoFactory;->createPrivateKeyInfo(Lorg/bouncycastle/crypto/params/AsymmetricKeyParameter;)Lorg/bouncycastle/asn1/pkcs/c;
    ...
    invoke-direct {v2, v0}, Lorg/bouncycastle/asn1/k;-><init>(Ljava/math/BigInteger;)V
    ...
    invoke-direct {p0, v1}, Lorg/bouncycastle/asn1/z0;-><init>(Lorg/bouncycastle/asn1/f;)V
    ...
    invoke-static {p0, v0}, Lorg/bouncycastle/util/a;->m([B[B)[B
...
.method public static parsePrivateKeyBlob([B)Lorg/bouncycastle/crypto/params/AsymmetricKeyParameter;
    ...
    invoke-static {p0}, Lorg/bouncycastle/crypto/util/OpenSSHPrivateKeyUtil;->allIntegers(Lorg/bouncycastle/asn1/s;)Z

    move-result v1

    if-eqz v1, :cond_8

    invoke-virtual {p0, v0}, Lorg/bouncycastle/asn1/s;->q(I)Lorg/bouncycastle/asn1/e;
    ...
    invoke-virtual {p0, v3}, Lorg/bouncycastle/asn1/s;->q(I)Lorg/bouncycastle/asn1/e;

    move-result-object v2

    check-cast v2, Lorg/bouncycastle/asn1/k;

    invoke-virtual {v2}, Lorg/bouncycastle/asn1/k;->q()Ljava/math/BigInteger;

    move-result-object v2

    invoke-virtual {p0, v6}, Lorg/bouncycastle/asn1/s;->q(I)Lorg/bouncycastle/asn1/e;

    move-result-object v3

    check-cast v3, Lorg/bouncycastle/asn1/k;

    invoke-virtual {v3}, Lorg/bouncycastle/asn1/k;->q()Ljava/math/BigInteger;

    move-result-object v3

    invoke-virtual {p0, v5}, Lorg/bouncycastle/asn1/s;->q(I)Lorg/bouncycastle/asn1/e;
    ...
    instance-of v0, v0, Lorg/bouncycastle/asn1/x;
    ...
    invoke-virtual {p0}, Lorg/bouncycastle/asn1/sec/a;->k()Lorg/bouncycastle/asn1/r;
    ...
    invoke-static {v0}, Lorg/bouncycastle/crypto/util/SSHNamedCurves;->getByName(Ljava/lang/String;)Lorg/bouncycastle/asn1/n;

    move-result-object v0

    if-eqz v0, :cond_6

    invoke-static {v0}, Lorg/bouncycastle/asn1/nist/a;->c(Lorg/bouncycastle/asn1/n;)Lorg/bouncycastle/asn1/x9/h;
    ...
    invoke-direct {v2, v0, p0}, Lorg/bouncycastle/crypto/params/ECNamedDomainParameters;-><init>(Lorg/bouncycastle/asn1/n;Lorg/bouncycastle/asn1/x9/h;)V
