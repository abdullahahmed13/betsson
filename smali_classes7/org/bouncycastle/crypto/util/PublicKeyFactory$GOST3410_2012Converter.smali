...
.method public getPublicKeyParameters(Lorg/bouncycastle/asn1/x509/d;Ljava/lang/Object;)Lorg/bouncycastle/crypto/params/AsymmetricKeyParameter;
    ...
    invoke-static {p2}, Lorg/bouncycastle/asn1/cryptopro/c;->j(Ljava/lang/Object;)Lorg/bouncycastle/asn1/cryptopro/c;

    move-result-object p2

    invoke-virtual {p2}, Lorg/bouncycastle/asn1/cryptopro/c;->k()Lorg/bouncycastle/asn1/n;
    ...
    invoke-direct {v3, v1, v4}, Lorg/bouncycastle/crypto/params/ECNamedDomainParameters;-><init>(Lorg/bouncycastle/asn1/n;Lorg/bouncycastle/asn1/x9/h;)V

    invoke-virtual {p2}, Lorg/bouncycastle/asn1/cryptopro/c;->h()Lorg/bouncycastle/asn1/n;

    move-result-object v4

    invoke-virtual {p2}, Lorg/bouncycastle/asn1/cryptopro/c;->i()Lorg/bouncycastle/asn1/n;

    move-result-object p2

    invoke-direct {v2, v3, v1, v4, p2}, Lorg/bouncycastle/crypto/params/ECGOST3410Parameters;-><init>(Lorg/bouncycastle/crypto/params/ECDomainParameters;Lorg/bouncycastle/asn1/n;Lorg/bouncycastle/asn1/n;Lorg/bouncycastle/asn1/n;)V
    ...
    sget-object p2, Lorg/bouncycastle/asn1/rosstandart/a;->h:Lorg/bouncycastle/asn1/n;
    ...
    :cond_1
    invoke-virtual {v2}, Lorg/bouncycastle/crypto/params/ECDomainParameters;->getCurve()Lorg/bouncycastle/math/ec/e;

    move-result-object p1

    invoke-virtual {p1, v1}, Lorg/bouncycastle/math/ec/e;->j([B)Lorg/bouncycastle/math/ec/i;

    move-result-object p1

    new-instance p2, Lorg/bouncycastle/crypto/params/ECPublicKeyParameters;

    invoke-direct {p2, p1, v2}, Lorg/bouncycastle/crypto/params/ECPublicKeyParameters;-><init>(Lorg/bouncycastle/math/ec/i;Lorg/bouncycastle/crypto/params/ECDomainParameters;)V
