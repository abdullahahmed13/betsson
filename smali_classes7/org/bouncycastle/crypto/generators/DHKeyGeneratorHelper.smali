...
.method public calculatePrivate(Lorg/bouncycastle/crypto/params/DHParameters;Ljava/security/SecureRandom;)Ljava/math/BigInteger;
    ...
    :cond_0
    invoke-static {v0, p2}, Lorg/bouncycastle/util/b;->e(ILjava/security/SecureRandom;)Ljava/math/BigInteger;
    ...
    invoke-static {p1}, Lorg/bouncycastle/math/ec/x;->h(Ljava/math/BigInteger;)I
    ...
    :cond_4
    invoke-static {v1, p1, p2}, Lorg/bouncycastle/util/b;->f(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/security/SecureRandom;)Ljava/math/BigInteger;

    move-result-object v2

    invoke-static {v2}, Lorg/bouncycastle/math/ec/x;->h(Ljava/math/BigInteger;)I
