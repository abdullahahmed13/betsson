...
# virtual methods
.method public a(I)Lorg/bouncycastle/asn1/e;
    .locals 3
    ...
    :cond_1
    new-instance p1, Lorg/bouncycastle/asn1/f0;

    invoke-direct {p1, p0}, Lorg/bouncycastle/asn1/f0;-><init>(Lorg/bouncycastle/asn1/w;)V
    ...
    invoke-direct {p1, p0}, Lorg/bouncycastle/asn1/o0;-><init>(Lorg/bouncycastle/asn1/w;)V
...
.method public b()Lorg/bouncycastle/asn1/e;
    ...
    invoke-virtual {p0, v1}, Lorg/bouncycastle/asn1/w;->e(Z)V

    iget-object v2, p0, Lorg/bouncycastle/asn1/w;->a:Ljava/io/InputStream;

    invoke-static {v2, v0}, Lorg/bouncycastle/asn1/j;->z(Ljava/io/InputStream;I)I
    ...
    :cond_3
    invoke-static {v5, v6, v1}, Lorg/bouncycastle/asn1/j;->w(Ljava/io/InputStream;IZ)I
    ...
    new-instance v1, Lorg/bouncycastle/asn1/t1;

    iget-object v3, p0, Lorg/bouncycastle/asn1/w;->a:Ljava/io/InputStream;

    iget v5, p0, Lorg/bouncycastle/asn1/w;->b:I

    invoke-direct {v1, v3, v5}, Lorg/bouncycastle/asn1/t1;-><init>(Ljava/io/InputStream;I)V
    ...
    invoke-direct {v0, v2, v3}, Lorg/bouncycastle/asn1/a0;-><init>(ILorg/bouncycastle/asn1/w;)V
    ...
    invoke-direct {v0, v4, v2, v3}, Lorg/bouncycastle/asn1/j0;-><init>(ZILorg/bouncycastle/asn1/w;)V
    ...
    invoke-direct {v4, v5, v1, v6}, Lorg/bouncycastle/asn1/r1;-><init>(Ljava/io/InputStream;II)V
    ...
    invoke-virtual {v4}, Lorg/bouncycastle/asn1/r1;->l()[B

    move-result-object v1

    invoke-direct {v0, v3, v2, v1}, Lorg/bouncycastle/asn1/h1;-><init>(ZI[B)V
    ...
    invoke-direct {v0, v3, v2, v1}, Lorg/bouncycastle/asn1/j0;-><init>(ZILorg/bouncycastle/asn1/w;)V
    ...
    invoke-direct {v0, v1}, Lorg/bouncycastle/asn1/p1;-><init>(Lorg/bouncycastle/asn1/w;)V
    ...
    invoke-direct {v0, v1}, Lorg/bouncycastle/asn1/n1;-><init>(Lorg/bouncycastle/asn1/w;)V
    ...
    invoke-direct {v0, v1}, Lorg/bouncycastle/asn1/o0;-><init>(Lorg/bouncycastle/asn1/w;)V
    ...
    invoke-direct {v0, v1}, Lorg/bouncycastle/asn1/d0;-><init>(Lorg/bouncycastle/asn1/w;)V
    ...
    invoke-static {v2, v4, v0}, Lorg/bouncycastle/asn1/j;->c(ILorg/bouncycastle/asn1/r1;[[B)Lorg/bouncycastle/asn1/r;
    ...
    invoke-direct {v0, v4}, Lorg/bouncycastle/asn1/w0;-><init>(Lorg/bouncycastle/asn1/r1;)V

    return-object v0
.end method

.method public c(ZI)Lorg/bouncycastle/asn1/r;
    .locals 3
    ...
    invoke-direct {v2, p1}, Lorg/bouncycastle/asn1/v0;-><init>([B)V

    invoke-direct {v1, v0, p2, v2}, Lorg/bouncycastle/asn1/q1;-><init>(ZILorg/bouncycastle/asn1/e;)V
    ...
    instance-of v1, v1, Lorg/bouncycastle/asn1/t1;
    ...
    new-instance v1, Lorg/bouncycastle/asn1/i0;

    invoke-virtual {p1, v0}, Lorg/bouncycastle/asn1/f;->d(I)Lorg/bouncycastle/asn1/e;

    move-result-object p1

    invoke-direct {v1, v2, p2, p1}, Lorg/bouncycastle/asn1/i0;-><init>(ZILorg/bouncycastle/asn1/e;)V
    ...
    invoke-static {p1}, Lorg/bouncycastle/asn1/b0;->a(Lorg/bouncycastle/asn1/f;)Lorg/bouncycastle/asn1/e0;

    move-result-object p1

    invoke-direct {v1, v0, p2, p1}, Lorg/bouncycastle/asn1/i0;-><init>(ZILorg/bouncycastle/asn1/e;)V
    ...
    invoke-direct {v1, v2, p2, p1}, Lorg/bouncycastle/asn1/q1;-><init>(ZILorg/bouncycastle/asn1/e;)V
    ...
    invoke-direct {v1, v0, p2, p1}, Lorg/bouncycastle/asn1/q1;-><init>(ZILorg/bouncycastle/asn1/e;)V

    return-object v1
.end method

.method public d()Lorg/bouncycastle/asn1/f;
    .locals 3
    ...
    :cond_1
    instance-of v2, v0, Lorg/bouncycastle/asn1/s1;

    if-eqz v2, :cond_2

    check-cast v0, Lorg/bouncycastle/asn1/s1;

    invoke-interface {v0}, Lorg/bouncycastle/asn1/s1;->b()Lorg/bouncycastle/asn1/r;
