...
.method public constructor <init>(Ljava/lang/String;Landroidx/recyclerview/widget/RecyclerView;Landroidx/recyclerview/selection/ItemKeyProvider;Landroidx/recyclerview/selection/ItemDetailsLookup;Landroidx/recyclerview/selection/StorageStrategy;)V
    ...
    invoke-static {}, Landroidx/recyclerview/selection/FocusDelegate;->stub()Landroidx/recyclerview/selection/FocusDelegate;
...
.method public build()Landroidx/recyclerview/selection/SelectionTracker;
    ...
    new-instance v5, Landroidx/recyclerview/selection/a;

    invoke-direct {v5, v4}, Landroidx/recyclerview/selection/a;-><init>(Landroidx/recyclerview/widget/RecyclerView;)V
    ...
    new-instance v6, Landroidx/recyclerview/selection/ToolSourceKey;

    const/4 v7, 0x0

    invoke-direct {v6, v7}, Landroidx/recyclerview/selection/ToolSourceKey;-><init>(I)V

    invoke-virtual {v1, v6, v5}, Landroidx/recyclerview/selection/EventRouter;->set(Landroidx/recyclerview/selection/ToolSourceKey;Landroidx/recyclerview/widget/RecyclerView$OnItemTouchListener;)V
    ...
    invoke-virtual {v2, v8}, Landroidx/recyclerview/selection/DefaultSelectionTracker;->addObserver(Landroidx/recyclerview/selection/SelectionTracker$SelectionObserver;)V

    new-instance v8, Landroidx/recyclerview/selection/ToolSourceKey;

    invoke-direct {v8, v7}, Landroidx/recyclerview/selection/ToolSourceKey;-><init>(I)V
    ...
    invoke-virtual {v15, v8, v9}, Landroidx/recyclerview/selection/EventRouter;->set(Landroidx/recyclerview/selection/ToolSourceKey;Landroidx/recyclerview/widget/RecyclerView$OnItemTouchListener;)V
    ...
    iget-object v8, v0, Landroidx/recyclerview/selection/SelectionTracker$Builder;->mMonitor:Landroidx/recyclerview/selection/OperationMonitor;

    invoke-virtual {v8}, Landroidx/recyclerview/selection/OperationMonitor;->asResettable()Landroidx/recyclerview/selection/Resettable;

    move-result-object v8

    invoke-virtual {v6, v8}, Landroidx/recyclerview/selection/ResetManager;->addResetHandler(Landroidx/recyclerview/selection/Resettable;)V
    ...
    new-instance v6, Landroidx/recyclerview/selection/b;

    invoke-direct {v6, v14}, Landroidx/recyclerview/selection/b;-><init>(Landroidx/recyclerview/selection/GestureSelectionHelper;)V
    ...
    invoke-direct {v11, v4}, Landroidx/recyclerview/selection/c;-><init>(Landroidx/recyclerview/selection/EventBackstop;)V
    ...
    invoke-direct {v6, v5}, Landroidx/recyclerview/selection/ToolSourceKey;-><init>(I)V

    invoke-virtual {v13, v6, v1}, Landroidx/recyclerview/selection/GestureRouter;->register(Landroidx/recyclerview/selection/ToolSourceKey;Landroid/view/GestureDetector$OnGestureListener;)V

    invoke-virtual {v15, v6, v14}, Landroidx/recyclerview/selection/EventRouter;->set(Landroidx/recyclerview/selection/ToolSourceKey;Landroidx/recyclerview/widget/RecyclerView$OnItemTouchListener;)V
    ...
    :cond_4
    new-instance v10, Landroidx/recyclerview/selection/ToolSourceKey;

    const/16 v3, 0x2002

    const/4 v4, 0x1

    invoke-direct {v10, v4, v3}, Landroidx/recyclerview/selection/ToolSourceKey;-><init>(II)V

    invoke-virtual {v13, v10, v1}, Landroidx/recyclerview/selection/GestureRouter;->register(Landroidx/recyclerview/selection/ToolSourceKey;Landroid/view/GestureDetector$OnGestureListener;)V
    ...
    invoke-direct {v1, v4}, Landroidx/recyclerview/selection/ToolSourceKey;-><init>(I)V

    invoke-virtual {v15, v1, v3}, Landroidx/recyclerview/selection/EventRouter;->set(Landroidx/recyclerview/selection/ToolSourceKey;Landroidx/recyclerview/widget/RecyclerView$OnItemTouchListener;)V

    invoke-virtual {v15, v10, v3}, Landroidx/recyclerview/selection/EventRouter;->set(Landroidx/recyclerview/selection/ToolSourceKey;Landroidx/recyclerview/widget/RecyclerView$OnItemTouchListener;)V
