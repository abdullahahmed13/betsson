...
.method public animateBasedOnPlayTime(JJZ)V
    ...
    :goto_2
    iget-object p5, p0, Landroidx/core/animation/AnimatorSet;->mEvents:Ljava/util/ArrayList;
    ...
    check-cast p5, Landroidx/core/animation/AnimatorSet$AnimationEvent;

    invoke-virtual {p5}, Landroidx/core/animation/AnimatorSet$AnimationEvent;->getTime()J
    ...
    :cond_2
    iget v4, p5, Landroidx/core/animation/AnimatorSet$AnimationEvent;->mEvent:I

    if-ne v4, v3, :cond_4

    iget-object v3, p5, Landroidx/core/animation/AnimatorSet$AnimationEvent;->mNode:Landroidx/core/animation/AnimatorSet$Node;

    iget-wide v4, v3, Landroidx/core/animation/AnimatorSet$Node;->mEndTime:J
    ...
    :cond_4
    iget v3, p5, Landroidx/core/animation/AnimatorSet$AnimationEvent;->mEvent:I

    const/4 v4, 0x2

    if-ne v3, v4, :cond_5

    iget-object p5, p5, Landroidx/core/animation/AnimatorSet$AnimationEvent;->mNode:Landroidx/core/animation/AnimatorSet$Node;

    iget-object p5, p5, Landroidx/core/animation/AnimatorSet$Node;->mAnimation:Landroidx/core/animation/Animator;

    invoke-virtual {p5, v2}, Landroidx/core/animation/Animator;->skipToEndValue(Z)V
    ...
    iget v0, p5, Landroidx/core/animation/AnimatorSet$AnimationEvent;->mEvent:I
    ...
    invoke-virtual {p5, v3}, Landroidx/core/animation/Animator;->skipToEndValue(Z)V
    ...
    check-cast p4, Landroidx/core/animation/AnimatorSet$Node;

    invoke-direct {p0, p1, p2, p4, v8}, Landroidx/core/animation/AnimatorSet;->getPlayTimeForNode(JLandroidx/core/animation/AnimatorSet$Node;Z)J

    move-result-wide v0

    if-nez v8, :cond_9

    iget-object p5, p4, Landroidx/core/animation/AnimatorSet$Node;->mAnimation:Landroidx/core/animation/Animator;

    invoke-virtual {p5}, Landroidx/core/animation/Animator;->getStartDelay()J
    ...
    iget-object v3, p4, Landroidx/core/animation/AnimatorSet$Node;->mAnimation:Landroidx/core/animation/Animator;
...
.method public setCurrentPlayTime(J)V
    ...
    iget-object p1, v4, Landroidx/core/animation/AnimatorSet;->mSeekState:Landroidx/core/animation/AnimatorSet$SeekState;

    iget-boolean p2, v4, Landroidx/core/animation/AnimatorSet;->mReversing:Z

    invoke-virtual {p1, v5, v6, p2}, Landroidx/core/animation/AnimatorSet$SeekState;->setPlayTime(JZ)V
