...
.field public x:Landroid/media/session/PlaybackState;
...
.method public constructor <init>(IJJFJILjava/lang/CharSequence;JLjava/util/List;JLandroid/os/Bundle;)V
    ...
    .line 3
    iput-wide p2, p0, Landroid/support/v4/media/session/PlaybackStateCompat;->d:J

    .line 4
    iput-wide p4, p0, Landroid/support/v4/media/session/PlaybackStateCompat;->e:J

    .line 5
    iput p6, p0, Landroid/support/v4/media/session/PlaybackStateCompat;->f:F

    .line 6
    iput-wide p7, p0, Landroid/support/v4/media/session/PlaybackStateCompat;->g:J
    ...
    .line 9
    iput-wide p11, p0, Landroid/support/v4/media/session/PlaybackStateCompat;->o:J
    ...
    iput-object p1, p0, Landroid/support/v4/media/session/PlaybackStateCompat;->p:Ljava/util/List;

    .line 11
    iput-wide p14, p0, Landroid/support/v4/media/session/PlaybackStateCompat;->v:J

    move-object/from16 p1, p16

    .line 12
    iput-object p1, p0, Landroid/support/v4/media/session/PlaybackStateCompat;->w:Landroid/os/Bundle;
...
.method public static a(Ljava/lang/Object;)Landroid/support/v4/media/session/PlaybackStateCompat;
    ...
    iput-object v1, v4, Landroid/support/v4/media/session/PlaybackStateCompat;->x:Landroid/media/session/PlaybackState;
